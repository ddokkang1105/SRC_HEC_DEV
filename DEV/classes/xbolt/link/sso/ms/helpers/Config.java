...
public class Config {
 ...
 "app.protect.authenticated", "app.graphUserScopes"};
 private static final List<String> REQ_PROPS = Arrays.asList(REQUIRED);

 private static Properties instantiateProperties() {
     final Properties props = new Properties();
     try {
         props.load(Config.class.getClassLoader().getResourceAsStream("/xbolt/link/sso/ms/authentication.properties"));
 ...
 public static final String REDIRECT_URL = Config.getProperty("app.redirectURL");
 ...
 public static final String AUTHORIZATION_CODE = Config.getProperty("aad.authorizationCode");
 public static final String GRAPH_USER_SCOPES = Config.getProperty("aad.graphUserScopes");
