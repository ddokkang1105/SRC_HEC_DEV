package xbolt.link.sso.ms.authwebapp;
...
import xbolt.link.sso.ms.helpers.IdentityContextData;
...
public class TokenDetailsServlet extends HttpServlet {
 ...
 private HashMap<String,String> filterClaims(IdentityContextData context) {
     final String[] claimKeys = {"sub", "aud", "ver", "iss", "name", "oid", "preferred_username", "nonce", "tid", "roles", "groups", "_claim_names", "_claim_sources"};
