...
// TODO : FOOTER
    ...
    String imageFileName = logoPath + "logo_SKBS.png";
    builder.write("SKBS 차세대 통합시스템 구축 PI");
    ...
    String imageFileName2 = logoPath + "logo_SKinc.png";
...
// 		    }
		...
		if (totalList.size() > 0) { 
	 	for (int index = 0; totalList.size() > index ; index++) {	 		
			...
			//builder.insertCell();
    		builder.insertImage(imageFileName, 125, 30);
