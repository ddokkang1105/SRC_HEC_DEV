...
<script>
	...
	if ('${systemtype}' == 'NCO') {
		grid = new dhx.Grid("grid", {
			    columns:[
			    	...
			    	{ width: 50, id: "Action", header: [{ text: "상태", align: "center" }], align: "center" },
   ...
   function goEAIUpateList() {
		var url = "/custom/zHdhi_getEAIUpdateList.do";
		var target = "actFrame";
...
<div id="proDiv" style="overflow:auto;">
	<div class="floatL msg" style="width:100%">
		<img src="${root}${HTML_IMG_DIR}/bullet_blue.png" id="subTitle_baisic">&nbsp;&nbsp;호출 결과 리스트</span>
	</div>	
	<div class="countList" >
        ...
        <li class="floatR">
           <span class="btn_pack nobg"><a class="move"  id="update" onclick="goEAIUpateList();" title="EAI Upate List"></a></span>
         </li>
	</div>
