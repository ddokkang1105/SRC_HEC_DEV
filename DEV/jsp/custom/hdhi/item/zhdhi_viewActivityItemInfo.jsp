		...
		<div id="itemDiv" class="pdT10">
			...
			<div id="process">
				<table class="tbl_preview mgB30">
					...
					<tr>
					<tr>
						<th>${attrNameMap.AT00021 }</th>
						<td class="alignL pdL10" colspan="7">
							<textarea style="width:100%;height:50px;" readonly="readonly">${attrMap.AT00021}</textarea>
						</td>
					</tr>
					<tr>
						<th>${attrNameMap.AT00006 }</th>
						<td class="alignL pdL10" colspan="7">
							<textarea style="width:100%;height:50px;" readonly="readonly">${attrMap.AT00006}</textarea>
						</td>
					</tr>
				</table>
			</div>
