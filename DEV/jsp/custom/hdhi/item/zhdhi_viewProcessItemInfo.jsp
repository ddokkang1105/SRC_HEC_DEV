					...
					<tr>
						...
						<td class="alignL pdL10" colspan="7">
							<div style="width:100%;height:200px;">
								<textarea class="tinymceText" id="AT00003" name="AT00003" readonly="readonly">${attrMap.AT00003}</div></textarea>
							</div>
						</td>
					</tr>
					<tr>
						<th>${attrNameMap.AT00010 }</th>
						<td class="alignL pdL10" colspan="3">${attrMap.AT00010}</td>
						<th>${attrNameMap.AT00012 }</th>
						<td class="alignL pdL10" colspan="3">${attrMap.AT00012}</td>
					<tr>
					<tr>
						<th>${attrNameMap.AT00013 }</th>
						<td class="alignL pdL10" colspan="3">${attrMap.AT00013}</td>
						<th>${attrNameMap.AT00020 }</th>
						<td class="alignL pdL10" colspan="3">${attrMap.AT00020}</td>
					<tr>
					<tr>
						<th>${attrNameMap.AT00024 }</th>
						<td class="alignL pdL10" colspan="3">${attrMap.AT00024}</td>
						<th>${attrNameMap.AT00022 }</th>
						<td class="alignL pdL10" colspan="3">${attrMap.AT00022}</td>
					<tr>
					<tr>
						<th>${attrNameMap.AT00006 }</th>
						<td class="alignL pdL10" colspan="3">${attrMap.AT00006}</td>
						<th>${attrNameMap.AT00026 }</th>
						<td class="alignL pdL10" colspan="3">${attrMap.AT00026}</td>
					<tr>
				</table>
			</div>
