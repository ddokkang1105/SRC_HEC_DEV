...
// 		setSchdlFrame();
    ...
    function setCSFrame(){ 
        var url = "zSKON_olmMainChangeSetList.do";
        var target = "csFrame";
        var data = "languageID=${sessionScope.loginInfo.sessionCurrLangType}&defDimValueID=${defDimValueID}";
    ...
    function setProcessFrame(){
        var url = "zSKON_mainSttProcessChart.do";   
    ...
    function fnBoardQnA() {
		...
		var data = "languageID=${sessionScope.loginInfo.sessionCurrLangType}&BoardMgtID=BRD0201&listSize=5&searchType=001";
		ajaxPage(url, data, target);
	}
    ...
    function fnGoMore(id, onTab){
    	var focusMenu ="";
       	...
       	if(onTab == "SCHDL"){
            ...
            var data = "&languageID=${sessionScope.loginInfo.sessionCurrLangType}&modStartDT="+fromDate+"&modEndDT="+toDate+"&isNotIn=N&dimTypeID=100001&dimValueID=${defDimValueID}";
    ...
    function fnClickedTask(avg) {
		...
		if(avg == 1){ // myitem
			...
			<c:forEach items="${myRewBrdList}" var="list" varStatus="status">
				result += '<ul onclick="fnDetail(\'BRD0203\',\'${list.BoardID}\')">';
    ...
    function fnClickMoreTask(){
    	...
    	if(taskID == "3") {
			...
			var data = "&BoardMgtID=BRD0203&myBoard=Y";
			var target = "layerBody";
    		ajaxPage(url, data, target);
    	}
    }
	...
	<div id="mainWrapper">
		<div id="leftDiv">
			...
			<div id="chartAndMyItem">
				<div id="chartDiv">
					<div class="charTit">
						<ul>
							<li class="titNM">Standard document Statistics</li>
						</ul>
					</div>
		       ...
		       <c:when test="${empty(srType)}">
		     		<div id="esrListDiv">
			 			<div class="secTit">
							...
							<ul class="morebtn" onClick="javascript:fnClickMoreBoard('BRD0201');">
								<li>more</li>
							</ul>
						</div>
		...
		<div id="rightDiv">
			...
			<div id="taskDiv">
	 			<div class="tabs">
					<ul>
						<li id="task2" class="on titNM" onclick="javascript:fnClickedTask('2');">${menu.LN00242}<span style="color: #fff; padding-right: 6px; padding-left: 6px; font-weight: normal; background-color: #62b3ed; border-radius: 18px; margin-top: 2px;margin-left: 8px; padding-bottom: 1px;"></span></li>
						<li id="task1" class="titNM" onclick="javascript:fnClickedTask('1');">${menu.LN00194}<span style="color: #fff; padding-right: 6px; padding-left: 6px; font-weight: normal; background-color: #62b3ed; border-radius: 18px; margin-top: 2px;margin-left: 8px; padding-bottom: 1px;"></span></li>
