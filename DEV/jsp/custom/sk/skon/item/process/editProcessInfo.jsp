...
// 					document.getElementById("ZAT01051").value = data.list.filter(e => e.AttrTypeCode === "ZAT01051")[0].LovCode;
				...
				if(data.list.filter(e => e.AttrTypeCode === "ZAT01060").length){
					document.getElementById("ZAT01060Value").insertAdjacentHTML("beforeend", data.list.filter(e => e.AttrTypeCode === "ZAT01060")[0].PlainText);
					document.getElementById("ZAT01060").value = data.list.filter(e => e.AttrTypeCode === "ZAT01060")[0].LovCode;
				}
				if(data.list.filter(e => e.AttrTypeCode === "ZAT02022").length){
					...
					document.getElementById("ZAT02022").value = data.list.filter(e => e.AttrTypeCode === "ZAT02022")[0].LovCode;
				}
...
// 					attrTypeCodesInput.value = attrTypeCodeList.join(','); // 쉼표로 구분된 문자열
					if("${itemInfo.ClassCode}" == "CL01005" || "${itemInfo.ClassCode}" == "CL01006A") {
						attrTypeCodesInput.value = "AT00001,AT00803,ZAT02016,ZAT02017,ZAT02020,AT01007"
					}
				
					if("${itemInfo.ClassCode}" == "CL01006A" || "${itemInfo.ClassCode}" == "CL01006B") {
						attrTypeCodesInput.value = "AT00001,AT00003,AT01007"
					}
			...
			<div id="process" class="mgB10">
				...
				<table class="tbl_preview mgB10">
					...
					<tr>
						<!-- 담당Site -->
						<th>${menu.ZLN0089}</th>
						<td  colspan="2" class="alignL pdL10" id ="ZAT01010Value"></td>
						<!-- 담당부서 -->
						<th>${menu.ZLN0074}</th>
						...
						<!-- 문서레벨 -->
						<th>${menu.ZLN0075}</th>
						<td colspan="2" class="alignL pdL10" id="ZAT01020Value">
					...
					<tr>
						<!-- 영역 -->		
     					<th>${menu.ZLN0072}</th>
					    <td colspan="2" class="alignL pdL10" id="ZAT01030Value">
					   <input type="hidden" id="ZAT01030" name="ZAT01030" class="text" >
					    </td>	
					   	<!-- 상세영역 -->
					    <th>${menu.ZLN0073}</th>
						<td class="alignL pdL10" id="ZAT02022Value">
						<input type="hidden" id="ZAT02022" name="ZAT02022" class="text" >
						</td>
						<!-- 문서유형 -->
						<th>${menu.LN00091}</th>
						...
						<!-- 문서분야 -->
						<th class="L4show">${menu.ZLN0085}</th>
						<td class="alignL pdL10 L4show" colspan="2" id="ZAT01040Value">
							<input type="hidden" id="ZAT01040" name="ZAT01040" class="text" >
						</td>						
						<td class="L4hidden"></td>
						<td class="L4hidden" colspan="2"></td>
					</tr>
					<tr style="height:40px;">
						...
						<td class="alignL pdL10 L4show" id="ZAT01050Value"></td>
						<!-- 상세공정 -->
						<th class="L4show"><span style="color: red;">*</span>${menu.ZLN0067}</th>
						<td class="alignL pdL10 L4show" colspan="2" id="ZAT01051Value"></td>								
						<td class="L4hidden"></td>
						<td class="L4hidden"></td>
						<td class="L4hidden"></td>
						<td class="L4hidden"></td>
					...
					<tr name="a" class="attr">
						<th><span style="color: red;">*</span>${menu.LN00386}</th>
						<td class="alignL pdL10" colspan="9">
							<textarea class="edit" style="width:100%;height:40px;resize:vertical;" id="AT00803" name="AT00803">${attrMap.AT00803}</textarea>
						</td>
					</tr>
					<!-- 적용범위 -->
					<tr name="a" class="attr">
						<th><span style="color: red;">*</span>${menu.ZLN0091}</th>
						<td class="alignL pdL10" colspan="9">
							<textarea class="edit" style="width:100%;height:40px;resize:vertical;" id="ZAT02016" name="ZAT02016">${attrMap.ZAT02016}</textarea>
						</td>
					</tr>
					<!-- 책임과 권한 -->
					<tr name="a" class="attr">
						<th><span style="color: red;">*</span>${menu.ZLN0092}</th>
						<td class="alignL pdL10" colspan="9">
					...
					<!--  기록 및 보관 -->
					<tr name="a" class="attr">			
						<th><span style="color: red;">*</span>${menu.ZLN0093}</th>
						<td class="alignL pdL10" colspan="9" >
							<textarea class="tinymceText" style="width:100%;height:250px;" id="ZAT02020" name="ZAT02020">${attrMap.ZAT02020}</textarea>
						</td>
					</tr>
					<!-- 문서개요 -->
					<tr name="b" class="attr">
						<th><span style="color: red;">*</span>${menu.ZLN0094}</th>
						<td class="alignL pdL10" colspan="9">
							<textarea class="tinymceText" id="AT00003" name="AT00003" style="width: 100%; height: 270px;">${attrMap.AT00003}</textarea>
						</td>
					</tr>
					<!-- 키워드 -->
					<tr>
					...
					<tr>
						...
						<td class="alignL pdL10" colspan="9">			
							<textarea class="edit" id="Description" name="Description" style="width:100%;height:40px;resize:vertical;">${csInfo.Description}</textarea>  
						</td>
					</tr>
					<!-- 첨부문서 -->
					<tr>
...
<script>
	...
	const grid1 = new dhx.Grid("", {
		columns: [
	        ...
	        { width: 600, id: "path", header: [{ text: "${menu.LN00102}" , align: "center" }], align: "left" },
