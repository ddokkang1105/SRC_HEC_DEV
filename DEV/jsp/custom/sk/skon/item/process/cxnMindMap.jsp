...
// 			});
			...
			roleMindMap.events.on("itemClick", (id, event) => {
			    if( id.substr(0,4) != "TXT_" && id.substr(0,8) != "docLev4_"  && id.substr(0,8) != "docLev5_")
			    {
			    	fnDetail(id);
			    }
			    if(id.substr(0,8) == "docLev4_") fnDetail(id.split("_")[1]);
			    if(id.substr(0,8) == "docLev5_") fnDetail(id.split("_")[2]);
			});
