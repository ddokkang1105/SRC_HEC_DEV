	...
	<div class="countList">
          ...
          <li class="floatR pdR20">			   
			...
			<c:if test="${myItem == 'Y' && itemBlocked ne '2'}">			
				...
				<c:if test="${itemClassCode ne 'CL01010'}">
...
<script>
	...
	var grid = new dhx.Grid("grid",  {
	    columns: [
	        ...
	        { width: 30, id: "checkbox", header: [{ htmlEnable: true, text: "<input type='checkbox' onclick='fnMasterChk(checked)'></input>" , align: "center"}], editorType: "checkbox", align: "center", type: "boolean",  editable: true, sortable: false, htmlEnable: true}, 
	...
	if("${itemClassCode}" == "CL01010") {
		grid.hideColumn("FileStatus")
	}
	...
	grid.events.on("cellClick", function(row,column,e){
		...
		if(fileOption=="ExtLink"){
			...
			} else if("${sessionScope.loginInfo.sessionMlvl}" == "SYS" || "${selectedItemAuthorID}" == "${sessionScope.loginInfo.sessionUserId}"){
				var isNew = "N";								
