   ...
   // BEGIN ::: GRID
	...
	var grid = new dhx.Grid("grid", {
	    columns:[
	    	...
	    	{ width: 80, id: "CMM", header: [{ text: "전사공통", align: "center" }], align: "left" },
	    	{ width: 50, id: "D01", header: [{ text: "식품", align: "center" }], align: "left" },
	    	{ width: 50, id: "D02", header: [{ text: "전략", align: "center" }], align: "left" },
	    	{ width: 50, id: "D03", header: [{ text: "유가공", align: "center" }], align: "left" },
	    	{ width: 50, id: "D04", header: [{ text: "건식", align: "center" }], align: "left" },
	    	{ width: 120, id: "C101", header: [{ text: "(국내)동원F&B", align: "center" }], align: "left" },
	    	{ width: 120, id: "C102", header: [{ text: "(국내)동원디어푸드", align: "center" }], align: "left" },
