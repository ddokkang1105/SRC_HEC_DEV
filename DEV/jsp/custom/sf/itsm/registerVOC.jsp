...
<script type="text/javascript">
	...
	function fnSelectSetting(all) {
		...
		resetSelect(all);
		// 01. category setting
		fnSelect('category', selectData +"&srType=" + srType +"&level=1&customerNo=${sessionScope.loginInfo.sessionClientId}&procPathID=${procPathID}", 'getESPSRCategory', '${category}', 'Select','esm_SQL');
		fnGetSubCategory('');
	}
