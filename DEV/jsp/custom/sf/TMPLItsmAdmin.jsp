...
<%-- <%@ include file="/WEB-INF/jsp/tiles/footer.jsp"%> --%>
...
console.log("timeout :>> ${timeout}");
	...
	jQuery(document).ready(function() {	
	    ...
	    '    <p class="user_info-out" style="display: inline;">USER IP : <%=userIP%> Login Date : <%=nowTime%> USER Info : [${sessionScope.loginInfo.sessionLoginId}] ${sessionScope.loginInfo.sessionUserNm}</p>' +
	    '</div>';
    ...
    function fnSearchFile(avg){
    	var searchValue = $("#mainSearchValue").val();
    	var url = "fileListMgt.do"; // var url = "goDocumentList.do";
    	var target = "container";
    	var data = "screenType=main&searchKey=Name&searchValue="+searchValue++"&url=file/searchItemFileList&listFilterType=search";
...
// 		tmplCode=layerType;
		...
		window.open("tmplMgt.do?dTempleCode="+layerType, "its-admin");
	}
