...
function handleBlock(e) {
    ...
    // F12, Ctrl+Shift+I/J/C/K 차단
    if (e.key === 'F12' || (e.ctrlKey && e.shiftKey && ['i', 'j', 'c', 'k'].includes(e.key.toLowerCase()))) {
        e.preventDefault();
        return false;
    }
...
document.addEventListener('keypress', handleBlock, true);
...
function generateDatePicker(){$(this).css({"min-width":"85px", "text-align":"left","padding-left":"5px"});$(this).css({"ime-mode":"disabled"});$(this).attr("size", "10");$(this).attr("maxlength", "10");$(this).attr("autocomplete","off");$(this).click(function() {doClickCalendar("Y", this);});var root = fnGetRootUrl();}
// TODO ::: IE8 대응으로 입시 삭제 
function generateDatePicker(){$(this).css({"min-width":"85px", "text-align":"left","padding-left":"5px"});$(this).css({"ime-mode":"disabled"});$(this).attr("size", "10");$(this).attr("maxlength", "10");$(this).attr("autocomplete","off");$(this).click(function() {doClickCalendar("Y", this);});$(this).blur(function() {closeCalendar();});var root = fnGetRootUrl();}
...
divScpt.treeTop=divScpt.treeTop+"<input type='text' class='tree_search' id='schTreeText' style='width:80px;ime-mode:active;' placeholder='Search124412124421' value='' text=''/>&nbsp;<a onclick='searchTreeText(\"1\")'><img src='${root}cmm/common/images/btn_icon_search.png'></a> <a onclick='searchTreeText(\"2\")'><img src='${root}cmm/common/images/icon_arrow_left.png'></a> | <a onclick='searchTreeText(\"3\")'><img src='${root}cmm/common/images/icon_arrow_right.png'></a>&nbsp;";divScpt.treeTop = divScpt.treeTop+"<a onclick='fnRefreshTree(null,true)'><img src='${root}cmm/common/images/img_refresh.png'></a>";divScpt.treeTop=divScpt.treeTop+"</div>";divScpt.cntnTop="";return divScpt;}
