...
var serviceCode = "Dab40_10_PSiteActivityDtil0001";
...
<tr>
			...
			<tr>
				<th class="alignC">Detail Process 선행</th>
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].PROP_DP_LINK}</td>
			</tr>
			<tr>
			...
			<tr>
				<th class="alignC">개선 Activity 여부</th>
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].YN_IPVT}</td>
			</tr>				
			<tr>
				<th class="alignC">이행점검</th>
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].PROP_EXEC_CHK}</td>
			</tr>				
			<tr>
			...
			<tr>
				<th class="alignC">회의체 여부</th>
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].YN_METG}</td>
			</tr>		
		</c:otherwise>
		</c:choose>
		</table>
