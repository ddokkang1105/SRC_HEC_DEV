...
var serviceCode = "Dab40_10_CStdActivityDtil0001";
	...
	<div id="obAttrDiv" style="margin-bottom:20px;overflow-x:hidden;overflow-y:hidden;">
		<table class="tbl_blue01" style="width:100%;margin-top:5px;" >
			...
			<tr>
				...
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].NM_CNTN_STATUS}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].NM_GK_TYPE}</td>
			</tr>
			<tr>
				<th class="alignC">최종승인</th>
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].NM_GK_MA}</td>
			</tr>
			<tr>
				<th class="alignC">Done 처리 사용</th>
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].PROP_YN_CPLT_USE}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].YN_NTFC}</td>
			</tr>
			<tr>
				<th class="alignC">알림주기</th>
				<td class="alignL last" style="padding:5px 0 5px 10px;">${manual[0].NM_NTFC_CYCL}</td>
			</tr>
