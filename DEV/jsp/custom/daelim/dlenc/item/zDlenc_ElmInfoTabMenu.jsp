...
<script type="text/javascript">
	...
	$(document).ready(function(){
		setoccFrame('zDlenc_ObjectAttrInfo','1','${filter}');
		$("#plisOM1").click(function() {setoccFrame('zDlenc_ObjectAttrInfo','1','${filter}');});
		$("#plisOM2").click(function() {setoccFrame('zDlenc_ObjectOutputInfo','2','${filter}');});
		$("#plisOM4").click(function() {setoccFrame('modelFilterMenu','3','${filter}');});
	});
...
<div class="ddoverlap" style="line-height:1.3em;">
	<ul>
		<li id="plisOM1" ><a><span>${menu.LN00031}</span> </a></li>
		<li id="plisOM2" ><a><span>계획/실적</span></a></li>
