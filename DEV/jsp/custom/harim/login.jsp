...
<div id="wrapper1">
	<!-- 1번 시안 -->
	<h1>
		<div class="login_logo"><img src="${root}${HTML_IMG_DIR}/logo_color.png"></div>
		<div><img src="${root}${HTML_IMG_DIR}/logo.png"></div>
	</h1>
	<p class="login_title">Harim Standardized Operation Platform</p>
	
	<div class="logwrap1">
		<div class="loginarea1" style="position:relative; width:880px; height:100%; background:url('${root}${HTML_IMG_DIR}/new_login_harim.png') no-repeat;">
			<form id="loginForm" name="loginForm" action="#" method="post" onsubmit="return false;">
				...
				<div class="loginForm1">
					<ul>
						<li style="text-align:center;font-wieght:bold;font-size:24px;color:#000;">LOG IN</li>
						<li>
