...
<script>
   ...
   // BEGIN ::: GRID
	...
	var grid = new dhx.Grid("grid", {
	    columns:[
	    	{ width: 120, id: "RuleCode", header: [{ text: "Rule Set", align: "center", colspan : 9 }, { text: "ID", align: "center" }, { content: "inputFilter" }], align: "left" },
	    	{ width: 100, id: "RuleName", header: ["", { text: "명칭", align: "center" }, { content: "inputFilter" }], align: "left" },
	    	{ width: 60, id: "RuleClass", header: ["", { text: "클래스", align: "center" }, { content: "selectFilter" }], align: "left" },
	    	{ width: 220, id: "Description", header: ["", { text: "개요", align: "center" }, { content: "inputFilter" }], align: "left" },
	    	{ width: 90, id: "APPLTYPE", header: ["", { text: "System Type", align: "center" }, { content: "selectFilter" }], align: "center" },
	    	{ width: 90, id: "ITSYS", header: ["", { text: "IT System", align: "center" }, { content: "selectFilter" }], align: "center" },
	    	{ width: 100, id: "ZAT14", header: ["", { text: "사전 리스크 관리", align: "center" }, { content: "selectFilter" }], align: "center" },
	    	{ width: 120, id: "AT06", header: ["", { text: "비고/이슈", align: "center" }, { content: "inputFilter" }], align: "left" },
	    	{ width: 220, id: "AT21", header: ["", { text: "적용방안상세", align: "center" }, { content: "inputFilter" }], align: "left" },
   ...
   function fnReloadGrid(newGridData){
	...
	function doExcel() {
		...
		if(start > delay || delay == 0){
			...
			fnGridExcelDownLoad('','Y','하림그룹 Rule Set List', 'custom_SQL.zharim_getAllExcelRuleSetList_gridList');
/* 			grid.export.xlsx({
...
<div id="proDiv" style="overflow:auto;">
	<div class="floatL msg" style="width:100%">
		<img src="${root}${HTML_IMG_DIR}/bullet_blue.png" id="subTitle_baisic">&nbsp;&nbsp;Rule Set List</span>
	</div>	
	<div class="countList" >
