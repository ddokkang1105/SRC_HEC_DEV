			...
			builder.endTable().setAllowAutoFit(false);
	 		...
	 		if ("N".equals(onlyMap)) {
				...
				builder.insertCell();	
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("AT00022")));  // 담당PI
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("AT00025")));  // 담당 컨설턴트
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("AT00006")));  // 비고/이슈
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("ZAT0011")));  // Business Type
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("ZAT0012")));  // Division
...
/* 	 	 		for(int j=0; j<dimResultList.size(); j++){
	 					...
	 					headerNO++;
	 			 		...
	 			 		if (elementList.size() > 0) {
	 						...
	 						for(int j=0; j<elementList.size(); j++){
	 							...
	 							itemName = itemName.replace("&#xa;", "");
	 							itemName = itemName.replace("&nbsp;", " ");
	 							String processInfo = StringUtil.checkNullToBlank(cnProcessData.get("Description")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
				...
				if (String.valueOf(request.getAttribute("cxnYN")).equals("on")) {
					if(relItemClassCodeList.size() > 0) {
						for(int i=0; i <relItemClassCodeList.size() ; i++){
							if(relItemClassCodeList.get(i).equals("CL07002")||relItemClassCodeList.get(i).equals("CL08002")){
								builder.insertBreak(BreakType.SECTION_BREAK_NEW_PAGE);
								break;
							}
						}
				...
				if (String.valueOf(request.getAttribute("subItemYN")).equals("on")) {
					...
					for(int j=0; j<activityList.size(); j++){
						...
						builder.getFont().setSize(10);
						builder.getFont().setBold(false);
						builder.writeln(StringUtil.checkNullToBlank(rowActData.get("AT00013"))); // IT System
						builder.insertHtml("<br>");
						
						builder.getFont().setSize(11);
						builder.getFont().setBold(true);
						builder.writeln( "["+StringUtil.checkNullToBlank(AttrTypeList.get("AT00010")) +"]");
						builder.getFont().setSize(10);
						builder.getFont().setBold(false);
						builder.writeln(StringUtil.checkNullToBlank(rowActData.get("AT00010"))); // 수행부서
						builder.insertHtml("<br>");
						
						builder.getFont().setSize(11);
						builder.getFont().setBold(true);
						builder.writeln( "["+StringUtil.checkNullToBlank(AttrTypeList.get("AT00006")) +"]");
						builder.getFont().setSize(10);
						builder.getFont().setBold(false);
						builder.writeln(StringUtil.checkNullToBlank(rowActData.get("AT00006"))); // 비고/이슈
						builder.insertHtml("<br>");
						
						builder.getFont().setSize(11);
						builder.getFont().setBold(true);
						builder.writeln( "["+StringUtil.checkNullToBlank(AttrTypeList.get("AT00046")) +"]");
						builder.getFont().setSize(10);
						builder.getFont().setBold(false);
						builder.writeln(StringUtil.checkNullToBlank(rowActData.get("AT00046"))); // Fit/GAP
						builder.insertHtml("<br>");
						
						builder.getFont().setSize(11);
						builder.getFont().setBold(true);
						builder.writeln("["+StringUtil.checkNullToBlank(AttrTypeList.get("AT00020")) +"]"); // 모듈
						builder.getFont().setSize(10);
						builder.getFont().setBold(false);
						builder.writeln(StringUtil.checkNullToBlank(rowActData.get("AT00020"))); // 모듈
						builder.insertHtml("<br>");
						
						builder.getFont().setSize(11);
						builder.getFont().setBold(true);
						builder.writeln("["+StringUtil.checkNullToBlank(AttrTypeList.get("AT00014")) +"]"); // 화면코드
						builder.getFont().setSize(10);
						builder.getFont().setBold(false);
						...
						builder.getFont().setSize(11);
						builder.getFont().setBold(true);
						builder.writeln("["+StringUtil.checkNullToBlank(AttrTypeList.get("ZAT0011")) +"]"); // Business Type
						builder.getFont().setSize(10);
						builder.getFont().setBold(false);
						builder.writeln(StringUtil.checkNullToBlank(rowActData.get("ZAT0011"))); // Business Type
						builder.insertHtml("<br>");
				
						builder.getFont().setSize(11);
						builder.getFont().setBold(true);
						builder.writeln("["+StringUtil.checkNullToBlank(AttrTypeList.get("ZAT0012")) +"]"); // Division
						builder.getFont().setSize(10);
						builder.getFont().setBold(false);
						builder.writeln(StringUtil.checkNullToBlank(rowActData.get("ZAT0012"))); // Division
						builder.insertHtml("<br>");
