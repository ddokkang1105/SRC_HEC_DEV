...
// 			//window.open(url,1316,h); 
	...
	function fnEditItemInfo() {
		...
		+"&itemEditPage=custom/samsung/sscnt/item/process/editUnitWorks"
	...
	async function getFileList() {
	    ...
	    if(data !== undefined && data !== null && data !== '') {
			...
			html += '<tr><th>No</th><th>문서유형</th><th>문서명</th><th>개정번호</th><th>작성자</th><th>등록일</th></tr>';
...
<!-- 		<div id="file" class="mgB30 pdT15"> -->
<!-- 			<p class="cont_title mgB10" id="csdoc_label">이전 버전 첨부문서</p> -->
<!-- 			<table  class="tbl_preview" id="csfileList"></table> -->
<!-- 		</div> -->
			
		 <!-- 용어의 정의 (cxn ver.) -->
		<div id="relatedTerm" class="mgB30 pdT15">
   		<p class="cont_title mgB10">용어의 정의</p>
		    <div id="cxn">
