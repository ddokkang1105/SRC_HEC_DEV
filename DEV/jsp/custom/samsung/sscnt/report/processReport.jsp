...
// TODO : FOOTER
    ...
    builder.insertCell();
    builder.getCellFormat().setWidth(200.0);
    builder.write("All SWP and Process");
			...
			builder.endTable().setAllowAutoFit(false);
	 		...
	 		if ("N".equals(onlyMap)) {
				...
				builder.getRowFormat().setHeight(30.0);
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("AT00092")));  // 목적
				...
				// 3.ROW : 상세업무절차	 	 	 	
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("ZAT4023")));  // 상세업무절차
	 	 		...
	 	 		String ZAT4023 = StringUtil.checkNullToBlank(attrMap.get("ZAT4023")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
	 	 		if ("1".equals(StringUtil.checkNullToBlank(attrHtmlMap.get("ZAT4023")))) { // type이 HTML인 경우
	 	 			if(StringUtil.checkNullToBlank(attrMap.get("ZAT4023")).contains("font-family")){
	 	 				builder.insertHtml(ZAT4023);
	 	 			}else{
	 	 				builder.insertHtml(fontFamilyHtml+ZAT4023+"</span>");
	 	 			}
	 	 		} else {
	 	 			builder.getFont().setBold(false);
	 	 			builder.write(ZAT4023); // 상세업무절차 : 내용
	 	 		}
	 	 		builder.endRow();
	 	 		//==================================================================================================	
	 	 		
	 	 		// 4.ROW : 정기검토일, System Type
	 	 		builder.insertCell();	
	 	 		//==================================================================================================	
	 	 		builder.getCellFormat().getShading().setBackgroundPatternColor(new Color(179, 179, 179));
	 	 		builder.getCellFormat().setWidth(titleCellWidth2);
	 	 		...
	 	 		builder.getCellFormat().setVerticalAlignment(CellVerticalAlignment.CENTER);
	 	 		builder.getFont().setBold (true);
	 	 		builder.write(String.valueOf(AttrTypeList.get("AT00055")));  // 정기검토일
	 	 		...
	 	 		if ("1".equals(StringUtil.checkNullToBlank(attrHtmlMap.get("AT00055")))) { // type이 HTML인 경우
	 	 			...
	 	 			builder.getFont().setBold(false);
	 	 			builder.write(StringUtil.checkNullToBlank(attrMap.get("AT00055"))); // 정기검토일 : 내용
	 	 		}
...
// 					    == [액티비티 개요] ==============
						builder.getFont().setBold(true);
					    builder.writeln(String.valueOf(AttrTypeList.get("AT00003")));  // 개요
						builder.getFont().setBold(false);
...
// 					    == [액티비티 수행시기] ==============
						builder.getFont().setBold(true);
					    builder.writeln(String.valueOf(AttrTypeList.get("AT00091")));  // 수행시기
						builder.getFont().setBold(false);
					    
						String ATVITAT00091 = StringUtil.checkNullToBlank(rowActData.get("AT00091")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
						if(StringUtil.checkNullToBlank(rowActData.get("AT00091")).contains("font-family")){	
							builder.insertHtml(ATVITAT00091);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVITAT00091+"</span>");
		 	 			}			 	 
						builder.insertHtml("<br>");
						builder.insertHtml("<br>");
// 						==================================
...
// 					    == [액티비티 시스템타입] ==============
						builder.getFont().setBold(true);
					    builder.writeln(String.valueOf(AttrTypeList.get("AT00037")));  // 시스템타입
						builder.getFont().setBold(false);
					    
						String ATVITAT00037 = StringUtil.checkNullToBlank(rowActData.get("AT00037")).replaceAll("&lt;","<").replaceAll("&gt;", ">").replaceAll("&quot;","\"").replace("upload/", logoPath);
						if(StringUtil.checkNullToBlank(rowActData.get("AT00037")).contains("font-family")){	
							builder.insertHtml(ATVITAT00037);
		 	 			}else{
		 	 				builder.insertHtml(fontFamilyHtml+ATVITAT00037+"</span>");
		 	 			}			 	 
						builder.insertHtml("<br>");
						builder.insertHtml("<br>");
// 						==================================
