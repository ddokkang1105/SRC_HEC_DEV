...
function fnLogin(isCheck) {
    ...
    url = "${pageContext.request.contextPath}/custom/youngone/loginYoungone.do"; 
	...
	<div id="wrapper1">
		<div class="logwrap1">
			...
			<form id="loginForm" name="loginForm" action="#" method="post" onsubmit="return false;">
				...
				<input name="srType" id="srType"  value="${srType}" type="hidden">
				<input name="esType" id="esType"  value="${esType}" type="hidden">
