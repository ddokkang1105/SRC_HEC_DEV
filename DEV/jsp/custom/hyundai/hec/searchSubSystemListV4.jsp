...
<script type="text/javascript">
	...
	var itemTypeCode = "${itemTypeCode}" || 'OJ00004';
...
<script>
/* ========================grid  api 방식 호출====================================   */
async function getSearchSubSystemList() {
    $('#loading').fadeIn(150);
...
grid = new dhx.Grid(null, {
    columns: [
        ...
        { flex: 1, id: "ItemName", header: [{ text: "명칭", align: "center" }, { content: "inputFilter" }], align: "left" },
        ...
        { width: 100, id: "ValidFrom", header: [{ text: "개정일", align: "center" }], align: "center" },
        ...
        { hidden: true, id: "FileIcon", header: [{ text: "File", align: "center" }], align: "center", htmlEnable: true,
          template: function (text, row) {
              return row.FileIcon ? '<img src="${root}${HTML_IMG_DIR_ITEM}/' + row.FileIcon + '" width="18" height="18">' : "";
          }
        },
        { width: 160, id: "Comment", header: [{ text: "비고", align: "center" }, { content: "inputFilter" }], align: "center" }
    ],
    autoWidth: true,
    resizable: true,
    selection: "row",
