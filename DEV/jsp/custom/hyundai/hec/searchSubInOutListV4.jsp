...
<script type="text/javascript">
	...
	var itemTypeCode = `${itemTypeCode}` || 'OJ00003';
...
<script>
/* ========================grid  api 방식 호출====================================   */
async function getSearchSubInOutList() {
    $('#loading').fadeIn(150);
...
grid = new dhx.Grid(null, {
    columns: [
        ...
        { width: 90, id: "ItemTypeName", header: [{ text: "클래스", align: "center" }], htmlEnable: true, align: "center",
...
async function doSearchList() {
    ...
    const success = await getSearchSubInOutList();
}
</script>
