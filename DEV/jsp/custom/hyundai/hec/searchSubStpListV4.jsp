...
<script type="text/javascript">
	...
	var itemTypeCode = `${itemTypeCode}` || 'OJ00016';
...
<script type="text/javascript">
/* ========================grid  api 방식 호출====================================   */
async function getSearchSTPList() {
    $('#loading').fadeIn(150);
    
    // 1. 기본 파라미터 구성 (STP 용 ClassCode: CL16004 적용)
...
var pagination;
    ...
    grid = new dhx.Grid(null, {
        columns: [
            ...
            { width: 150, id: "Identifier", header: [{ text: "STP No.", align: "center" }, { content: "selectFilter" }], align: "center" },
            ...
            { flex: 1, id: "ItemName", header: [{ text: "STP명", align: "center" }, { content: "selectFilter" }], align: "left" },
    ...
    grid.events.on("cellClick", function(row, column, e) {
        ...
        if (colId === "FileIcon") {
            ...
            if (fileCheck && fileCheck.indexOf("blank.gif") < 0) {
                ...
                var data = "?hideBlocked=Y&s_itemID=" + row.ItemID;
                var w = "400";
                var h = "350";
                window.open(url + data, "", "width=" + w + ", height=" + h + ", top=100,left=100,toolbar=no,status=no,resizable=yes");
            }
