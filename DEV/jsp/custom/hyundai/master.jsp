...
<link rel="stylesheet" type="text/css" href="${root}cmm/<%=GlobalVal.BASE_ATCH_URL%>/css/language.css?v=1.0.1" />
...
//     	ajaxPage(url, data, target);
	...
	function fnOpenItsm(){    	
    	var url = "https://hmgitsm.service-now.com/epc?id=hyundai_sc_catalog_item&sys_id=14c856951b946d104cd38550f54bcb45&previous_widget=epc_information_system&info_number=SM90000303&glide_sso_id=c6d47e8f1bd2d15091fddc6ac54bcb6c";
	...
	<header>
		<!-- logo -->
		  ...
		  <div class="search_form">
			...
			<ul class="h_right">
					<li class="pdL20"><img src="${root}${HTML_IMG_DIR}/icon_itsm.png" onclick="fnOpenItsm();" style="cursor:pointer" /></li>
					<li class="hypen ">			
       ...
       <div>
		<!--<button class="btn-sitemap" type="button">Site map<b><i></i><i></i><i></i></b></button>-->
		<c:choose>
	       <c:when test="${templCode == ''}">
	     		<div id="slidemenu01" class="slidemenu" style="display:block"></div>
	    	</c:when>
...
<!-- 	</div>	 -->
	<!-- END ::: CONTENTS -->
		<div id="main-layout" style="height: calc(100% - 153px);"></div>
		<iframe name="blankFrame" id="blankFrame" src="about:blank" style="display: none; overflow: hidden;" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
	<footer></footer>
</div>
</body>
