 ...
 <div class="countList">
	...
	<script>		
		...
		var grid = new dhx.Grid("gridArea", {
			type : "tree",
		    columns: [
		        { width: 380, id: "itemName", header: [{ text: "${menu.LN00028}", align: "center" }, { content: "inputFilter" }], align: "left", htmlEnable : true },
		        { width: 360, id: "Path", header: [{ text: "${menu.LN00043}", align: "center" }, { content: "inputFilter" }], align: "left" },
