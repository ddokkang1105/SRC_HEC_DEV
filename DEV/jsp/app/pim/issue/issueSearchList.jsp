    ...
    <tr>
      ...
      <tr>   
        ...
        <td colspan="3" class="last">     
            <input type="text" id="REQDUE_STR_DT" name="REQDUE_STR_DT" value="${beforeYmd}"	class="input_off datePicker stext" size="8"
				style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"	maxlength="10" >
			
			~
			<input type="text" id="REQDUE_END_DT" name="REQDUE_END_DT" value="${thisYmd}" class="input_off datePicker stext" size="8"
				style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"	maxlength="10">
        ...
        <th>${menu.LN00221}</th>
        <td colspan="3">     
            <input type="text" id="DUE_STR_DT" name="DUE_STR_DT" value="${beforeYmd}"	class="input_off datePicker stext" size="8"
				style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"	maxlength="10" >
			
			~
			<input type="text" id="DUE_END_DT" name="DUE_END_DT" value="${thisYmd}" class="input_off datePicker stext" size="8"
				style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"	maxlength="10">
        ...
        <th>${menu.LN00223}</th>
        <td colspan="3" class="last">     
            <input type="text" id="ACT_STR_DT" name="ACT_STR_DT" value="${beforeYmd}"	class="input_off datePicker stext" size="8"
				style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"	maxlength="10" >
			
			~
			<input type="text" id="ACT_END_DT" name="ACT_END_DT" value="${thisYmd}" class="input_off datePicker stext" size="8"
				style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"	maxlength="10">
