...
<script type="text/javascript">
	...
	function fnGoSRList(){ 
		var url = "vocpList.do";
		var data = "esType=${esType}&srType=${srType}&scrnType=${scrnType}&srMode=${srMode}&srStatus=${srStatus}&customerNo=${customerNo}&category=${srCategory}&searchSrCode=${searchSrCode}"
							+ "&itemProposal=${itemProposal}&subject=${subject}&varFilter=${varFilter}&itemID=${itemID}&defCategory=${defCategory}";
...
<div>
	...
	<table class="tbl_brd mgB5" style="table-layout:fixed;" width="100%" cellpadding="0" cellspacing="0"> 
		...
		<tr>
			...
			<td class="sline tit last">${sessionScope.loginInfo.sessionUserNm}(${sessionScope.loginInfo.sessionTeamName}/${sessionScope.loginInfo.sessionCompanyNm})</td>
			...
			<td class="sline tit last">	
				<input type="text" id="reqdueDate" name="reqdueDate" value="" class="input_off datePicker stext" size="8"
					...
					<input type="text" id="reqDueDateTime" name="reqDueDateTime" value="" class="input_off text" size="8" style="width:40%; text-align: center;" maxlength="10">
		    </td>
		</tr>
		<tr>
			<th class="alignL pdL10">${menu.LN00002}</th><!-- 제목 -->
			<td colspan="5" class="sline tit last" >
