...
var pmenuIndex = "1 2 3 4 5"; // 각 menu index (submenu 포함)
...
var srID = "${srID}";
	...
	function setSubFrame(avg, avg2){
		...
		var url = "vocpList.do";
		var data = "scrnType=${scrnType}&esType=${esType}&defCategory=${defCategory}&multiComp=${multiComp}";
		...
		if(avg == "1") {
			...
			url = "srAreaInfo.do";
			data = "ParentID=${projectID}&srType=${esType}";
		
		} else if(avg == "5") {
			url = "espList.do";
			data = data + "&srStatus=ALL";
		}
	...
	<div>
   	...
   	<div id="foldframe" class="foldframe">
		<div>
	       	<ul class="help_menu">	        
	            <!-- Issue List -->
	            <li class="helpstitle plus1"><a onclick="clickOpenClose(1);"><img src="${root}${HTML_IMG_DIR}/icon_pjt_chorder.png"><span class="fontchange">&nbsp;VOCP List</span></a></li>
                <li class="helpstitle line minus1" style="display:none;"><a class="on" onclick="clickOpenClose(1);"><img src="${root}${HTML_IMG_DIR}/icon_pjt_chorder.png"><span class="fontchange">&nbsp;VOCP List</span></a></li>
             	<li class="hlepsub line smenu1" style="display:none;"><a id="menuCng1" onclick="setSubFrame(1);">&nbsp;&nbsp;나의 서비스 요청</a></li>
             	<li class="hlepsub line smenu1" style="display:none;"><a id="menuCng2" onclick="setSubFrame(2);">&nbsp;&nbsp;개발 테스트</a></li>
             	<li class="hlepsub line smenu1" style="display:none;"><a id="menuCng3" onclick="setSubFrame(3);">&nbsp;만족도 평가</a></li>
             	<li class="hlepsub line smenu1" style="display:none;"><a id="menuCng4" onclick="setSubFrame(4);">&nbsp;서비스 데스크</a></li>
             	<li class="hlepsub line smenu1" style="display:none;"><a id="menuCng5" onclick="setSubFrame(5);">&nbsp;서비스 요청 검색</a></li>
	        </ul>
	   	</div>
	</div>
