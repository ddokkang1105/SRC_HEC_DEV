...
var grid = new dhx.Grid("grdOTGridArea", {
    columns: [
        ...
        { width: 100, id: "CompanyName", header: [{ text: "${menu.LN00014}" , align: "center" }, { content: "selectFilter" }], align: "center" },
        { width: 120, id: "ReqTeamNM", header: [{ text: "${menu.LN00026}" , align: "center" }, { content: "selectFilter" }], align: "center" },
        { width: 120,id: "ReqUserNM", header: [{ text: "${menu.LN00025}" , align: "center" }, { content: "inputFilter" }], align: "center" },
        { width: 100,id: "SRArea1Name", header: [{ text: "${srAreaLabelNM1}" , align: "center" }, { content: "selectFilter" }], align: "center" },
        { width: 100, id: "SRArea2Name", header: [{ text: "${srAreaLabelNM2}" , align: "center" }, { content: "selectFilter" }], align: "center" },
        { width: 90, id: "SubCategoryNM", header: [{ text: "${menu.LN00033}" , align: "center" }, { content: "selectFilter" }], align: "center" },
        ...
        { width: 120, id: "SRDueDate", header: [{ text: "${menu.LN00221}" , align: "center" }], align: "center" },
...
gridColumns = grid.config.columns;
if(multiComp!="Y") gridColumns[4].hidden = true;
