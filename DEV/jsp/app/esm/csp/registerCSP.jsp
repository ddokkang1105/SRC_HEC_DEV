...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		if("${itemProposal}" == "Y") {
			$("#itemListTR").attr("style","padding-top:10px;display:none;");
...
var grid = new dhx.Grid("grid", {
	columns: [
		...
		{ width: 120, id: "Identifier", header: [{ text: "${menu.LN00015}", align: "center" } ], align: "center" },
    	{ id: "ItemNM", header: [{ text: "${menu.LN00028}", align: "center" } ], align: "center" },
    	{ width: 150, id: "Path", header: [{ text: "${menu.LN00043}", align: "center" } ], align: "left" },
    	{ width: 100, id: "StatusNM", header: [{ text: "${menu.LN00027}", align: "center" } ], align: "center" },
    	{ width: 100, id: "AuthorName", header: [{ text: "${menu.LN00004}", align: "center" } ], align: "center" },
    	...
    	{ hidden: true, width: 80, id: "Status", header: [{ text: "Status", align: "center" } ], align: "center" }
	],
	autoWidth: true,
	resizable: true,
	selection: "row",
