...
<script>
	...
	var gridData = ${ispProcessingReportListData};
	...
	function doSearch(){
		var url = "ispProcessingReport.do";
		var data = "";
		var target = "ispProcessingReportList";
...
<!-- BEGIN :: SEARCH -->
<form name="ispProcessingReportList" id="ispProcessingReportList" action="#" method="post" onsubmit="return false;">
	<div class="cop_hdtitle" style="border-bottom:1px solid #ccc">
		<h3 style="padding: 3px 0 3px 0"><img src="${root}${HTML_IMG_DIR}/bullet_blue.png">&nbsp;&nbsp;이슈 처리 조사 리포트 (담당자 별)</h3>
	</div>
...
<script type="text/javascript">
	...
	function fnGridList(resultdata){
		...
		for(var i=0; i < total; i++){
			...
			grid.addCellCss(rowId, "Code", "point");
		}
