	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tbl_search" id="search">
		...
		<tr>
			...
			<td class="alignL viewtop">
				<input type="text" id="REG_STR_DT" name="REG_STR_DT" value="${beforeYmd}"   class="input_off datePicker text" size="8"
			      style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"   maxlength="10" >
				
			   ~
			   <input type="text" id="REG_END_DT" name="REG_END_DT" value="${thisYmd}"   class="input_off datePicker text" size="8"
			      style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"   maxlength="10">
			...
			<td class="alignL viewtop">
			    <input type="text" id="stSRDueDate" name=stSRDueDate value="${stSRDueDate}"   class="input_off datePicker text" size="8"
			      style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"   maxlength="10" >
			   
			   ~
			<input type="text" id="endSRDueDate" name="endSRDueDate" value="${endSRDueDate}"	class="input_off datePicker text" size="8"
			...
			<td class="alignL viewtop">
			      <input type="text" id="completionDT" name="completionDT" value="${completionDT}" class="input_off datePicker text" size="8"
			   style="width: 70px;text-align: center;" onchange="this.value = makeDateType(this.value);"   maxlength="10" >
