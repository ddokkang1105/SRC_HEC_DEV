...
function itemTypeCodeTreePop(recItemTypeCode,arcFilter) { 
	...
	// fnOpenLayerPopup(url,data,doCallBack,617,466);
	var w = 676;
	var h = 436;
...
// replace symbol 전 릴리즈처리
function fnRelease(replaceSymTypeCode, replaceLinkID, defSymSize, modelID){	
	ui.autoRelease(replaceSymTypeCode, replaceLinkID, defSymSize, modelID);
}
