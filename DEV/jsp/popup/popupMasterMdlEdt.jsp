...
jQuery(document).ready(function() {
	...
	srcUrl = srcUrl + "&languageID="+languageID
					...
					+ "&dimTypeFilter=${dimTypeFilter}"
					+ "&symTypeFilter=${symTypeFilter}"
					+ "&focusedItemID=${focusedItemID}";
	...
	// mdlFilter=Y Model Layer Option 
	function fnReloadModelFilter(opacityList, itemTypeCodeList, blurredList, dimTypeID, dimValueList, symTypeCodeList){
		$('#main').get(0).contentWindow.fnReloadModelFilter(opacityList, itemTypeCodeList, blurredList, dimTypeID, dimValueList, symTypeCodeList);
	}
</script>
</head><body>
