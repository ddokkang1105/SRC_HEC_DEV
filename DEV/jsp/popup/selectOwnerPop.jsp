...
<form name="OAIPFrm" id="OAIPFrm" action="" method="post" onsubmit="return false;">
	...
	<input type="hidden" id="myTransfer" name="myTransfer" value="${myTransfer}" />
	<input type="hidden" id="mailNotice" name="mailNotice" value="${mailNotice}" />
