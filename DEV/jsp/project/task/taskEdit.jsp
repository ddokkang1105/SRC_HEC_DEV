	...
	<div class="pdT10">
		<table class="tbl_task" style="padding-top:10px;" width="100%" border="0" cellpadding="0" cellspacing="0"  >
			...
			<tr>				
				...
				<td class="last">
					<input type="text" id="startDate${taskList.TaskTypeCode}" name="startDate${taskList.TaskTypeCode}" value="${taskList.StartDate}" class="text datePicker" size="8"
							style="width: 70px;" onchange="this.value = makeDateType(this.value);"	maxlength="10">
							
				</td>
				<td class="last">
					 <input type="text" id="endDate${taskList.TaskTypeCode}" name="endDate${taskList.TaskTypeCode}" value="${taskList.EndDate}" class="text datePicker" size="8"
							style="width: 70px;" onchange="this.value = makeDateType(this.value);"	maxlength="10">
