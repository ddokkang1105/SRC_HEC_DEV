...
$(document).ready(function(){
	...
	fnSelect('pjtCatName', data+"&category=PJTCAT", 'getDictionaryOrdStnm', "${getMap.PJCategory}", 'Select');
...
function savePrj(avg){
	...
	if(confirm("${CM00001}")){
		var url = "admin/savePrjInfo.do"; // 요청이 날라가는 주소
...
<form name="projectInfoFrm" id="projectInfoFrm" method="post" action="admin/savePrjInfo.do" onsubmit="return false;">
	<!-- SKON CSRF 보안 조치 -->
...
<div class="floatL msg" style="width:100%"><img src="${root}${HTML_IMG_DIR}/bullet_blue.png" id="subTitle_baisic">
		...
		<table class="tbl_blue01 mgT10" style="table-layout:fixed;" width="98%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr><!-- 명칭  -->
					...
					<td colspan="3" class="alignL last" >	
						<input type="text" class="text" id="ProjectName" name="ProjectName" value="${getMap.ProjectName}"/>
					</td>
					<th class="alignL pdL5">프로젝트 카테고리</th>
					<td class="alignL pdL5">
							<select id="pjtCatName" name="pjtCatName" style="width:90%"></select>
					</td>
				</tr>	
				<tr>
					<!-- 개요 -->
