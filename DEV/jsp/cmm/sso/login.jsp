...
function fnLogin(isCheck) {
    ...
    url = "${pageContext.request.contextPath}/link/sso/olmSSO.do"; 
	fnSetCookie();
...
<form id="dfForm" name="dfForm" action="" method="post">
	...
	<input name="docCategory" id="docCategory"  value="${docCategory}" type="hidden">
					...
					<ul>
					    ...
					    <li>
							<div class="login_logo">
								<img src="${root}${HTML_IMG_DIR}/logo_white.png">
							</div>
						</li>
					</ul>
				</div>
