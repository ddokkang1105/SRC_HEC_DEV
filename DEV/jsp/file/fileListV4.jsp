...
<form name="fileMgtFrm" id="fileMgtFrm" action="" method="post" onsubmit="return false">
	...
	<div class="pdB5 pdT10">
		...
		<div class="btn-wrap flex justify-between pdB5 countList">
...
<script>
	...
	//			 				itmInfoPopup(url,w,h); 					
						...
						async function showFileDetailPanel() {
							...
							html += '<ul class="pdL0">';
							html += '<li><a class="tab--active" onclick="selectFileTab(\'detail\', this)">상세 정보</a></li>';
							if(USE_FILE_LOG == "Y") html += '<li><a onClick="selectFileTab(\'log\', this)">활동</a></li>';
							html += '</ul>';
							...
							const params = new URLSearchParams(requestData).toString();
							const detailUrl = "getFileDetail.do?" + params;
