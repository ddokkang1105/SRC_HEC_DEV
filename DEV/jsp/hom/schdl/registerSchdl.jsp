...
<spring:message code="${sessionScope.loginInfo.sessionCurrLangCode}.WM00166" var="WM00166" />
...
<form name="schedlFrm" id="schedlFrm" action="" method="post" onsubmit="return false">
	...
	<input type="hidden" id="schdlType" name="schdlType" value="${schdlType}">
