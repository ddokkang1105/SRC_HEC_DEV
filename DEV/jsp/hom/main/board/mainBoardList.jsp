       ...
       <c:when test="${isView == '0'}">
    	...
    	<c:otherwise>
			...
			<ul onclick="fnDetail('${list.BoardMgtID}','${list.BoardID}')">
			    <li style="width:65%;max-width:595px;">${list.Subject}<c:if test="${list.chkNew == '1'}"><img src="${root}${HTML_IMG_DIR}/new.png"></c:if></li>
			  	<li style="width:20%;" class="alignC">${list.WriteUserNM}</li>
