...
<script type="text/javascript">
	...
	$(function() {
		setpmFrame('symbolTypeDetail', '', '1');
	});

	function setpmFrame(avg, oj, avg2) {		
		var url = avg + ".do";
		var data = "&SymTypeCode=${filter}"
				+ "&viewType=${viewType}"
...
<div class="SubinfoTabs"><!-- jsp명, 공백, 탭순서를 넘긴다. -->
	<ul>
		<li id="pliug1" class="on"><a href="javascript:setpmFrame('symbolTypeDetail','','1');"><span>Basis</span></a></li>
		<li id="pliug2"><a href="javascript:setpmFrame('allocateSymbolAttrDp','','2');"><span>Symbol Display</span></a></li> 
	</ul>
</div>
