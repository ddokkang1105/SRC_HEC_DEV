...
<script type="text/javascript">
	...
	function gridOnRowOTSelect(row){ 
		...
		var brdMgtId = row.BoardMgtID;
		$("#sortNum").val(sortNum);
		$("#sortNum").focus();
		$("#boardMgtID").val(brdMgtId);
	}
			...
			alert("${WM00023}");	
				...
				if(confirm("${CM00004}")){ 
					...
					for(idx in selectedCell){
						boardMgtID[idx] = selectedCell[idx].BoardMgtID;
					}
					var url = "admin/deleteBoardMgtAlloc.do";
	...
	function fnSaveStNum(){
		if(confirm("${CM00001}")){
			...
			var url = "admin/updateBoardMgtAllocStNum.do";
...
<script type="text/javascript">
		...
		var grid = new dhx.Grid("grdGridArea", {
		    columns: [
		        ...
		        { width: 80, id: "BoardMgtID", header: [{ text: "Code" , align: "center" }], align: "center" },
		        { width: 200, id: "BoardMgtName", header: [{ text: "Name", align: "center" }] },
		        { hidden:true, id: "TemplCode", header: [{ text: "TemplCode", align: "center" }], align: "center" },
		        { hidden:true, id: "TemplName", header: [{ text: "TemplName", align: "center" }], align: "center" },
		        { width: 80, id: "SortNum", header: [{ text: "Sort No", align: "center" }], align: "center" }
		    ],
		    autoWidth: true,
		    resizable: true,
		    selection: "row",
		...
		grid.events.on("cellClick",function(row, column, e){
	 	...
	 	function fnCallBack(){
			...
			var sqlID = "config_SQL.getBoardMgtAlloc";		
