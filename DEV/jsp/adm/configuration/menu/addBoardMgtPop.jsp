...
<script type="text/javascript">
	...
	function doOTSearchList(){
		var sqlID = "config_SQL.getBoardMgtList";
...
<script type="text/javascript">	//그리드 자바스크립트
	...
	var grid = new dhx.Grid(null, {
		columns: [
			...
			{ width: 90, id: "BoardMgtID", header: [{ text: "BoardMgtID" , align: "center" }], align: "center" },
			{ width: 180, id: "BoardMgtName", header: [{ text: "BoardMgtName", align: "center" }], align: "center" },
			{ width: 120, id: "TemplCode", header: [{ text: "TemplCode" ,align: "center" }], align: "center"}
		],
		autoWidth: true,
		resizable: true,
		selection: "row",
