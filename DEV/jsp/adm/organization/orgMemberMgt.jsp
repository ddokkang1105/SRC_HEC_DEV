...
function doSearchOUGList(){ 
	var sqlID = "organization_SQL.getOrgMemberList";
	    	...
	    	{ width: 50, id: "checkbox", header: [{ htmlEnable: true, text: "<input type='checkbox' onclick='fnMasterChk(checked)'></input>" , align: "center" }], align: "center", type: "boolean", editable: true, sortable: false},
	   		{ width: 50, id: "OrgTypeImg", header: [{ text: "${menu.LN00042}", align:"center" }], htmlEnable: true, align: "center",
	        	template: function (text, row, col) {
	        		return '<img src="${root}${HTML_IMG_DIR}/'+row.OrgTypeImg+'" width="16" height="16">';
	            }
	        },
	        {  width: 180,id: "UserNAME", header: [{ text: "Name", align: "center" } ], align: "center" },
	        { width: 120, id: "Position", header: [{ text: "Position", align: "center" } ], align: "center" },
	        { hidden: true, width: 110, id: "LoginID", header: [{ text: "LoginID", align: "center" } ], align: "center" },
	        { width: 180, id: "Email", header: [{ text: "Email", align: "center" } ], align: "left" },
	        { width: 110, id: "EmployeeNo", header: [{ text: "Employee No.", align: "center" } ], align: "center" },
	        { width: 120, id: "TelNum", header: [{ text: "Tel", align: "center" } ], align: "left" },
	        { width: 120, id: "CompanyNM", header: [{ text: "Company", align: "center" } ], align: "center" },
	        { width: 110, id: "AuthorityNm", header: [{ text: "Type", align: "center" } ], align: "center" },
	        { hidden: true, id: "MemberID", header: [{ text: "MemberID", align: "center" } ], align: "center" },
	        { hidden: true, id: "MLVL", header: [{ text: "MLVL", align: "center" } ], align: "center" },
	        { hidden: true, id: "MTelNum", header: [{ text: "MTelNum", align: "center" } ], align: "left" },
...
function saveOrgMemberInfo() {
	...
	if(confirm("${CM00001}")){ 
		var url    = "admin/saveOrgMemberInfo.do"; 
...
function doCallBack(avg){
 ...
 function updateManager(gubun){
	...
	var ManagerID = selectedCell[0].MemberID;
	var url = "admin/updateOrgManager.do";
