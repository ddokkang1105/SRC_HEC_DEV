...
<script type="text/javascript">
	...
	var layout = new dhx.Layout("grdGridArea", { 
		...
		var grid = new dhx.Grid(null, {
			columns: [
				...
				{ width: 80, id: "Name", header: [{ text: "Name", align: "center" }], align: "center" },
				{ width: 70, id: "EmployeeNum", header: [{ text: "${menu.LN00148}", align: "center"  }], align: "center"},
				{ width: 100, id: "CreationTime", header: [{ text: "Changed Date", align: "center" }] , align: "center"},				
				{ width: 100, id: "ChangeType", header: [{ text: "Change Type", align: "center" }], align: "center" },	
				{ width: 80, id: "Status", header: [{ text: "${menu.LN00027}", align: "center" }], align: "center" },
				{ width: 100, id: "CurTeamName", header: [{ text: "Current ${menu.LN00247}", align: "center" }], align: "center" },
				{ width: 100, id: "PrevTeamName", header: [{ text: "Prev. ${menu.LN00247}", align: "center" }], align: "center" },
				{ width: 90, id: "LastUpdated", header: [{ text: "${menu.LN00236}", align: "center" }], align: "center" },
				{ width: 90, id: "ActionType", header: [{ text: "ActionType", align: "center" }], align: "center" },
				{ width: 80, id: "LastUser", header: [{ text: "${menu.LN00220}", align: "center" }], align: "center" },
				...
				{ hidden: true, id: "AuthorID", header: [{ text: "AuthorID", align: "center" }], align: "center" }
			],
			autoWidth: true,
			resizable: true,
			selection: "row",
		...
		grid.events.on("cellClick", function(row,column,e){
			if(column.id != "checkbox" && (column.id == "LoginID" || column.id == "Name")){
	...
	function doSearchList(){
		var scStartDt = $("#SC_STR_DT").val();
		var scEndDt = $("#SC_END_DT").val();
		var status = $("#statusCode").val();
		var changeType = $("#changeTypeCode").val();
		var actionType = $("#actionTypeCode").val();

		var sqlID = "user_SQL.itemAuthorLogList";
		var param = 
