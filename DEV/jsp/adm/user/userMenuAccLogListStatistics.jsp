...
<script type="text/javascript">
	var gridData = ${UserMenuAccLogListStatisticsData};
	...
	function fnGridList(resultdata){		
		grid = new dhx.Grid("grid", {
			 ...
			 columns: [
				{ width: 120, id: "Date", header: [{ text: "날짜", align: "center" }, { content: "selectFilter", align: "center" }], align: "center" },
				{ width: 80, id: "OccurrenceCount", header: [{ text: "${menu.LN00030}", align: "center" }, { content: "selectFilter", align: "center" }], align: "center" },
				{ width: 120, id: "ActionType", header: [{ text: "메뉴유형", align: "center" }, { content: "selectFilter" }], align: "center" },					
	...
	<form name="changeInfoLstFrm" id="changeInfoLstFrm" method="post" action="#" onsubmit="return false;">
		  <div class="cop_hdtitle" style="border-bottom:1px solid #ccc">
			  	<li class="floatR pdR15">
					<div class="icon_color_btn2 searchList"  onclick="changeStatics()"  style="cursor:pointer; display:inline-block;" >
