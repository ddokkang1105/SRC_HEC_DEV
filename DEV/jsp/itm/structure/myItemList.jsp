...
// 	if(s_itemID != ""){
// 		tc_gridArea.forEachRow(function(id){
// 			/*alert(s_itemID+":::"+tc_gridArea.cells(id, 14).getValue()+"::::"+id);*/
// 			if(s_itemID == tc_gridArea.cells(id, 14).getValue()){
// 				tc_gridArea.selectRow(id-1);
// 			}
// 	});}
// }
