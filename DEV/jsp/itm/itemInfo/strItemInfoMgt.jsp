...
<script type="text/javascript">
	...
	function setActFrame(avg, avg2, avg3, avg4, avg5, avg6){
		...
		$("#menuType").val(avg6);
		if(height == 0){
			var topHeight = 5+$(".SubinfoTabs").height();height = document.body.clientHeight - topHeight;
		}
		var browserType="";
...
// 			}
	...
	function fnGoReportList() {
		...
		var target = "actFrame";
		var data = "s_itemID=${strItemID}&option=${option}&kbn=newItemInfo&strItemID=${strItemID}&mstItemID=${mstItemID}&structureID=${structureID}&udfSTR=${udfSTR}"; 
	...
	<ul>
		...
		<div id="itemNameAndPath">
	   		 ...
	   		 <img src="${root}${HTML_IMG_DIR_ITEM}/${itemInfo.ItemTypeImg}" OnClick="fnOpenParentItemPop('${parentItemID}');" style="cursor:pointer;">
			  	<font color="#3333FF"><b style="font-size:13px;">${itemInfo.ToItemCode}&nbsp;${itemInfo.ToItemName}</b></font>&nbsp;
