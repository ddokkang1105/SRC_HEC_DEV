...
// 	let defaultLang = "";
	...
	function transData() {
		...
		if(sourceLang == targetLang) {
			...
			fetch("/olmapi/transData/?memberID=${sessionScope.loginInfo.sessionUserId}&text="+text+"&itemID=${itemID}&languageID=${languageID}&attrTypeCode=${attrTypeCode}&sourceLang="+sourceLang+"&targetLang="+targetLang)
...
<!-- 			<p class="cont_title mgB15">PAPAGO 번역 기능</p> -->
			...
			<!-- 			<button onclick="savePapagoTrans()" class="cmm-btn2 floatR last mgT10">Save</button> -->
			<button onclick="transData()" class="cmm-btn2 floatR last mgT10">Translate</button>
		</div>
	</form>
