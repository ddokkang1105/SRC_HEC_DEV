...
<script>
	...
	function setGridData(){
		...
		var aligns = "";
		var aCnt = 14;
		var colWidth = (document.body.clientWidth - 225 - 150) / 14;
		...
		result.title = "";
		result.key = "";
		result.header = "${menu.LN00191},Total,${menu.LN00022},#cspan,#cspan,#cspan,#cspan,#cspan,${menu.LN00065},#cspan,#cspan,#cspan,#cspan,#cspan";
		result.attachHeader1 = "#rspan,#rspan,${cngtMap.NEW},#cspan,${cngtMap.MOD},#cspan,${cngtMap.DEL},#cspan,${cngStsMap.MOD},#cspan,${cngStsMap.CMP},#cspan,${cngStsMap.CLS},#cspan";
		
		result.widths = "170" + widths;
