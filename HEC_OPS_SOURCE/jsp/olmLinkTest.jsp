...
<div style="padding: 100px 100px 100px 100px">
	...
	<a href="olmLink.do?olmLoginid=sales&object=itm&linkType=id&linkID=101489&languageID=1042&option=AR000004" > 101. OLM LINK [ID] </a><br>
	...
	<a href="olmLink.do?olmLoginid=guest&object=itm&linkType=id&linkID=104894&languageID=1042">106. Item popup</a><br>
	...
	<span onClick="javascript:test('guest','CS','id','690','1042','','','','736790');"> 109.CS Approval Item Pop POST </span><br>
 	<a href="olmAprvDueLink.do?empNo=6&language=KR">110. Approval Due List</a><br><br>
