...
<div class=" pdT10 pdB10 pdR10 pdL10">
	<form name="orgInfo" id="orgInfo" action="#" method="post" onsubmit="return false;">
		...
		<table class="tbl_blue01 mgT10 mgB40" width="100%" border="0" cellpadding="0"	cellspacing="0">
			<colgroup>
				<col width="10%">
				<col width="27%">
				<col width="10%">
			...
			<tr>
				...
				<td class="alignL pdL10 last">${getMap.TeamManagerNM}</td>
			</tr>
			...
			<tr>
				...
				<td class="alignL pdL10">${getMap.RoleManagerNM}</td>
				<th class="alignL pdL10">No. of Change(1 Year)</th>
				<td class="alignL pdL10 last">${CSCNT}</td>
			</tr>
	...
	<div class="cmm_subTab mgB10">
		<ul>
			<li id="pliOM1"><a href="javascript:setorgFrame('ownerItemList','1','team');"><span>${menu.LN00190}</span></a></li>			
			<li id="pliOM2"><a href="javascript:setorgFrame('teamRoleMgt','2');"><span>${menu.LN00119}</span></a></li>	
	...
	<div id="orgFrame" style="height: 450px; overflow: auto;"></div>
</div>
</body>
</html>