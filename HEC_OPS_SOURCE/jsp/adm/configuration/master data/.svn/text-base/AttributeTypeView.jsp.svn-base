				...
				<td class="last" bgcolor="#f9f9f9" colspan="6">
				    ...
				    <div class="lovBTN">
						<c:if test="${resultMap.DataType == 'LOV' || resultMap.DataType == 'MLOV'}">
							<span class="btn_pack medium icon"><span class="list"></span><input value="LOV" type="submit"  onclick="ListOfValue()"></span>
						</c:if>
							<span class="btn_pack medium icon"><span class="list"></span><input value="List" type="submit" onclick="goBack()"></span>
							<span class="btn_pack medium icon"><span class="save"></span><input value="Save" type="submit" onclick="updateAttrribute()"></span>
					</div>
					</c:if>	 	
				</td>
			</tr>
