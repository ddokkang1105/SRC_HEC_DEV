...
<script type="text/javascript">
	...
	function setOTGridData(){
		...
		result.title = "${title}";
		result.key = "config_SQL.getMenuList";
		...
		result.data = "languageId=${languageID}&menuCat="+$("#menuCategory").val();
		return result;
	}
...
<body>
	...
	<div class="child_search mgT5" style="border:none; padding:0;">
		<li class="pdL20	">Category
	...
	<div id="gridDiv" class="mgT5 clear">
