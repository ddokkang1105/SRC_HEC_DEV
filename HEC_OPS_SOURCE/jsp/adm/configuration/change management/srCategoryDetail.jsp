...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		fnSelect('srArea', data, 'getDictionaryOrdStnm', '${resultMap.SRArea}', 'Select');			
	...
	<form name="srCatDetail" id="srCatDetail" action="#" method="post" onsubmit="return false;">
		...
		<table style="table-layout:fixed;" class="tbl_blue01" width="100%">
			...
			<tr>
				...
				<td class="viewtop">
					<input type="Text"  class="text" id="srCatID" name="srCatID" value="${resultMap.SRCatID}" >	
				</td>
			...
			<tr>	
				...
				<th class=" alignL pdL10">Response level</th>
				<td class=" alignL">
			...
			<tr>
				<td class="alignR pdR20 last" bgcolor="#f9f9f9" colspan="8">
					<c:if test="${sessionScope.loginInfo.sessionLogintype == 'editor'}">
						...
						<span class="btn_pack medium icon"> <span class="save"></span><input value="Save" type="submit" onclick="fnSaveSrCat()"></span>
					</c:if>
				</td>
			</tr>
		</table>
