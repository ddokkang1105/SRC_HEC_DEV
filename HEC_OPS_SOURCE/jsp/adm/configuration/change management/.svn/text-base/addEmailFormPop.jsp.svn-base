...
<form name="emailFrm" id="emailFrm" action="#" method="post" onsubmit="return false;">
	...
	<div id="editArea" style="margin:5px 10px;">
		...
		<tr>
			...
			<td class="alignL last"><input type="text" id="emailCode" name="emailCode" value="" class="text"></td>
		</tr>
		<tr>
		...
		<div class="alignBTN mgB5 mgR10">
			<span class="btn_pack medium icon"><span class="save"></span><input value="Save" onclick="fnSaveEmailForm()" type="submit"></span>
		</div>
	</div>
</form>
