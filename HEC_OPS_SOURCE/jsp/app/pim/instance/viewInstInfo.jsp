...
<form name="viewProcElmFrm" id="viewProcElmFrm" action="" method="post" onsubmit="return false;">	
	<div id="obAttrDiv" style="margin-top:5px;margin-bottom:20px;">
		...
		<c:choose>		
   		<c:when test="${elmInstanceInfo.size() > 0}">
			...
			<tr>
				<th style="height:20px;">${menu.LN00028}</th>
			...
			<tr>	
				<th style="height:20px;">Project</th>
			...
			<tr>
				<th style="height:20px;">role 명</th>
			...
			<tr>
				<th style="height:20px;">${menu.LN00004}</th>
			...
			<tr>
				<th style="height:20px;">${menu.LN00061}</th>
			...
			<tr>
				<th style="height:20px;">Email Date</th>
			...
			<tr>
				<th style="height:20px;">${menu.LN00027}</th>
				<td style="text-align:left" class="last"><input type="text" value="${elmInstanceInfo.StatusNM}" style="width:100%;border:0px;" readOnly></td>
			</tr>			
			<c:if test="${instAttrList.size() > 0}">
				...
				<c:choose>	
					...
					<c:otherwise>
						<tr>
							<th style="height:20px;">${attrList.AttrTypeName}</th>
		...
		<c:if test="${procInstanceInfo.size() > 0}">
			<tr>	
				<th style="height:20px;">Project No.</th>
			...
			<tr>
				<th style="height:20px;">Project Name</th>
				<td style="text-align:left" class="last"><input type="text" value="${procInstanceInfo.ProcInstanceNM}" style="width:100%;border:0px;" readOnly></td>
			</tr>
			<tr>	
				<th style="height:20px;">Manager</th>
