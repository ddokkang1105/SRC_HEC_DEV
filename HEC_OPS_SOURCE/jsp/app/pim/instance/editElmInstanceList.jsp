...
<script type="text/javascript">
	...
	function searchPopupWf(idx){
		var projectCode = gridArea.cells(idx, 3).getValue();
		var url = "searchPjtNamePop.do?&UserLevel=ALL&searchValue="+ $("#actorName_"+idx).val()
					+ "&projectCode="+projectCode
					+ "&searchKey=Name&languageID=${sessionScope.loginInfo.sessionCurrLangType}&objId="+idx;
...
// 		if(parseInt(schStartTime) > parseInt(endTime)) 	alert("${WM00132}"); return false;
	...
	function fnAssignActor(ind){
		...
		var url = "selectMemberPop.do?docCategory=assignWText&&s_memberIDs="+sharers;
