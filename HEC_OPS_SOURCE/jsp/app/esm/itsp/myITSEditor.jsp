...
var data = [
           { 
                id: "toggle",
				css: "toggle-button",
				html: "<div><img src='${root}${HTML_IMG_DIR}/icon_fold.png'/><span class='title'>IT Service</span></div>",
            },
            { 
                id: "user",
				html: "<div>" 
            ...
            },
            {
             ...
             },
             {
                 id: "csr",
                 value: "변경과제",
                 icon: "mdi mdi-folder-multiple-change",
             ...
             },
             {
                 id: "item",
                 value: "Contents",
                 icon: "mdi mdi-folder-multiple-manage",
	...
	function setPage(id,varFilter){
		...
		if(id === "toggle"){
			...
			if(sidebar.config.collapsed){
				...
				sidebar.data.update("toggle", {html: "<div><img src='${root}${HTML_IMG_DIR}/icon_fold.png'/><span class='title'>IT Service</span></div>"});
	...
	function fnSidebarInit(){
	 ...
	 function setCSFrame(){ 
	    ...
	    function setSCRFrame(){ 
	        ...
	        var target = "scrFrame";
	        var data = "listSize=4&scrMode=&mySCR=Y";
	        ajaxPage(url, data, target);
	    }
					...
					<div id="cntDiv">
						...
						<div class="cntFrame">
							<div class="sec" style="background:#4265EE;;">
								...
								<ul class="con">
									<li class="bd" onClick="setPage('srNew')"><p>${srNewCnt}</p>신규 문의</li>
									<li class="" onClick="setPage('srIng')"><p>${srIngCnt}</p>진행 중</li>
								</ul>
							</div>
							<div class="sec" style="background:#4087FB">
								...
								<ul class="con">
									<li class="bd" onClick="setPage('areq')"><p>${wfAREQCnt}</p>결재 상신</li>
							...
							<div class="sec" style="background:#109CD7">
								...
								<ul class="con">
									<li class="bd" onClick="setPage('scrIng')"><p>${scrIngCnt }</p>진행 중</li>
									<li class="" onClick="setPage('scrApr')"><p>${scrAprelCnt}</p>승인 완료</li>
								</ul>
							</div>
							<div class="sec" style="background:#1BB4F8">
								...
								<ul class="con">
									<li class="bd" onClick="setPage('ctsIng')"><p>${ctsIngCnt}</p>진행 중</li>
									<li class="" onClick="setPage('ctsApr')"><p>${ctsApreqCnt}</p>처리 대기</li>
								</ul>
							</div>
						</div>
					</div>
