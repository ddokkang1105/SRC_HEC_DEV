...
<script type="text/javascript">
	...
	function fnCompletion(){		
		...
		var url  = "completionItsp.do?speCode=SPE014";
		ajaxSubmit(document.receiptSRFrm, url,"saveFrame");
	}
...
<div id="processSRDIV"> 
	...
	<div class="alignBTN">				
		...
		<c:if test="${srInfoMap.SRNextStatus eq 'SPE005' && appBtn eq 'Y'}" >
		 ...
		 <c:if test="${srInfoMap.Status eq 'SPE002' && srInfoMap.SRNextStatus eq 'SPE014' && appBtn eq 'Y' && srInfoMap.ReceiptUserID == sessionScope.loginInfo.sessionUserId }" >
