...
<div id="processSRDIV"> 
	...
	<table class="tbl_brd" style="table-layout:fixed;" width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="sline tit last"><select id="category" name="category" class="sel" OnChange="fnGetSubCategory(this.value);"></select></td>
			<!-- 서브카테고리 -->
	...
	<div class="alignBTN">				
		<c:if test="${(srInfoMap.Status == 'SPE018' || srInfoMap.Status == 'SPE019')}" >
			...
			<c:if test="${srInfoMap.SRArea3Code == null}" >
			<span class="btn_pack small icon"><span class="move"></span><input value="Assign Item" type="submit" id="transferItem"></span>
			</c:if>
		</c:if>
