...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		fnSelect('itemTypeCd',data+"&level=1", 'getESMSRCatItemTpCd', '', 'Select', 'esm_SQL');
...
<div>
	...
	<table class="tbl_brd mgB5" style="table-layout:fixed;" width="100%" cellpadding="0" cellspacing="0"> 
		...
		<tr>
		    ...
		    <th class="alignL pdL10" style="height:15px;">${menu.LN00021}</th>
		  	<td class="sline tit last">
		  		<select id="itemTypeCd" name="itemTypeCd" class="sel" style="width:250px;margin-left=5px;" OnChange="fnGetSRCategory(this.value)"></select>
		  	</td>
		  	</c:if>
