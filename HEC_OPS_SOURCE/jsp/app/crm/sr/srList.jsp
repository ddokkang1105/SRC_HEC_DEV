...
<script>
	...
	function setGridData(){
		...
		result.cols = "SRCode|Subject|StatusName|RequestName|SRArea1Name|SRArea2Name|SubCategoryNM|ReceiptInfo|RegDate|SRDueDate|SRID|ReceiptUserID|Status|CRDueDate|SRCompletionDT|IsPublic|RequestUserID";
