		...
		<li class="floatR pdR20">
			<c:if test="${myItem == 'Y'}">
				<c:if test="${sessionScope.loginInfo.sessionLogintype == 'editor'}">
					...
					<span id="addBtn" class="btn_pack small icon"><span class="add"></span><input value="Add" type="submit" onclick="addRelItem();" title="Add"></span>
					<span class="btn_pack small icon"><span class="assign"></span><input value="Assign" type="submit" onclick="assignItem();" title="Assign Item"></span>
					<span class="btn_pack small icon"><span class="del"></span><input value="Del" type="submit" onclick="relItemDel();" title="Delete"></span>
				</c:if>	
			</c:if>		
		</li>
	</div>
