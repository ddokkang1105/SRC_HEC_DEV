...
<script>
	...
	function doTcSearchList(upLow){
		var tcd = setTcGridData(upLow);fnLoadDhtmlxGridJson(tc_gridArea, tcd.key, tcd.cols, tcd.data,false,false);
	}
	...
	<div style="overflow:auto;margin-bottom:5px;overflow-x:hidden;">	
		 <div class="countList">
              <li class="pdL20 floatL">
	   		...
	   		&nbsp;&nbsp;<input type="radio" name="upLow" value="2" onClick="doTcSearchList('Upper');">&nbsp;&nbsp;Upper
	   		&nbsp;&nbsp;<input type="radio" name="upLow" value="3" onClick="doTcSearchList('Lower');">&nbsp;&nbsp;Lower				
			  </li>
		</div>	
		<div class="countList">
            <li class="pdL20 floatL" >
				<span style="color:blue"> All : ${AllCNT} &nbsp;&nbsp;Upper : ${UpperCNT} &nbsp;&nbsp;Lower : ${LowerCNT} </span>				
			</li>
		</div>	
