...
<div class="clear"></div>
<div id="htmlReport" style="width:98%;overflow:auto; overflow-x:hidden; padding:0;margin:auto;">
<input type="hidden" id="url" name="url" >
	...
	<div class="child_search mgB10">
	  ...
	  <c:forEach var="prcList" items="${prcList}" varStatus="status">
	   ...
	   <c:if test="${modelID != '' && modelID != null}" ><span class="icon" alt="Occurrence" title="Occurrence"  style="cursor:pointer;_cursor:hand"><img onclick="fnOpenModel();" src="${root}${HTML_IMG_DIR}/img_folderClosed.png"></img></span>&nbsp;</c:if>
	   	<span class="icon" alt="CHANGEMGT" title="Change" style="cursor:pointer;_cursor:hand">
	...
	<!--  //end 기본정보 -->
						...
						<tr>
							...
							>
								<c:if test="${attrList.HTML eq '1'}">
									<textarea class="tinymceText" style="width:100%;height:${attrList.AreaHeight}px;" readonly="readonly">${attrList.PlainText}</textarea>
								</c:if>
		...
		<table style="table-layout:fixed;" width="100%" cellpadding="0" cellspacing="0" border="0" class="tbl_preview">
			...
			<tr>
				<!-- 변경내역 -->	
				<th>${menu.LN00136}</th>
				<td class="last alignL pdL5" style="width:100%;height:150px;">				
