...
<div id="htmlReport" style="padding:15px;">
	<div id="process">
		<p class="cont_title mgB15">Attribute Comparing</p>
		<table class="tbl_blue01">
			...
			<tr>
				...
				<th class="last pdT10 pdB10">
					Ver.${firChangeSetInfo.Version}&nbsp;Last released on&nbsp;${firChangeSetInfo.CompletionDT}&nbsp; 
					by ${firChangeSetInfo.AuthorName}
				</th>
				<th class="last pdT10 pdB10">
					Ver.${secChangeSetInfo.Version}&nbsp;Last released on&nbsp;${secChangeSetInfo.CompletionDT}&nbsp; 
					by ${secChangeSetInfo.AuthorName}
				</th>
			</tr>
