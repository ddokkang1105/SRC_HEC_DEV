...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		// 초기 표시 화면 크기 조정 
		$("#grdGridArea").attr("style","height:"+(setWindowHeight() - 210)+"px;");
		// 화면 크기 조정
	...
	function gridOnRowSelect(id, ind){		
		if(ind==3){ // 다운로드 이미지 클릭시 
			...
			fltpCode =  p_gridArea.cells(id, 14).getValue();
			...
			var url  = "documentDetail.do?isNew"+isNew+"&seq="
					...
					+"&itemTypeCode=${itemTypeCode}&fltpCode=${fltpCode}&classCode="+classCode+"&myDoc="+myDoc+"&screenType="+screenType+"&parentID="+parentID+"&isMember=${isMember}";
			var w = 1200;
			var h = 500;
...
<div style="width:100%">
    ...
    <tr>
        ...
        <th class=" alignL pdL10"><input type="text" id="regMemberName" name="regMemberName" class="text" style="width:98%;ime-mode:active;" ></th>      
	</tr>
    <tr>     
		<!-- 프로젝트 -->
		...
		<th class="pdL10 alignL" colspan=3>	
	   		<input type="text" id="searchValue" name="searchValue" value="${searchValue}" class="text" style="width:90.4%;ime-mode:active;">
