...
<div style="border-bottom:1px solid #ccc;padding-top:10px;">&nbsp;</div>
<table style="table-layout:fixed;" class="tbl_blue01 mgT10" width="100%" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<th class="viewtop">${menu.LN00043}</th>
	...
	<tr>
		<td colspan="8" style="height:180px;" class="tbl_preview last">
	...
	<tr>
		...
		<c:if test="${selectedItemBlocked == '0' && fileMap.Blocked ne 1 &&(selectedItemAuthorID == sessionScope.loginInfo.sessionUserId || sessionScope.loginInfo.sessionAuthLev == '1')}" >		
