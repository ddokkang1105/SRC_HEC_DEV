...
<body>
	...
	<div style="border-bottom:1px solid #896c41;" width="100%" border="0" cellpadding="0" cellspacing="0"  >			
		<span style="font-weight:bold;">&nbsp;&nbsp;&nbsp;- Edit Task</span>
	</div>		<br>
	...
	<table class="tbl_task" style="padding-top:10px;border-right:1px;" width="100%"  border="0" cellpadding="0" cellspacing="0"  >
		<tr>
			<th class="viewtop last" style="word-break:break-all" width="2%">No</th>
			<th class="last" style="word-break:break-all" width="4%">ID</th>
			<th class="last" style="word-break:break-all" width="8%">${menu.LN00028}</th>
			<th class="last" style="word-break:break-all" width="6%">Task</th>
			<th class="last" style="word-break:break-all" width="6%">${menu.LN00221}</th>
			<th class="last" style="word-break:break-all" width="6%">${menu.LN00063}</th>
			<th class="last" style="word-break:break-all" width="6%">${menu.LN00233}</th>
			<th class="last" style="word-break:break-all" width="9%">Program ID</th>
			<th class="last" style="word-break:break-all" width="9%">T_Code</th>
			<th class="last" style="word-break:break-all" width="3%">Down</th>
			<th class="last last2" style="word-break:break-all" width="2%">File</th>
		</tr>
		...
		<tr>
			...
			<td class="last">
				<c:if test="${taskList.FileID != null}"> 
					<img src="${root}${HTML_IMG_DIR}/btn_file_add.png" style="cursor:pointer;width:13;height:13;padding-left:10px" alt="fileDown" align="absmiddle" onclick="fnFileDownLoad('${taskList.FileRealName}','${taskList.FileName}','','${taskList.FileID}')">
				</c:if>
			</td>
			<td class="last">
