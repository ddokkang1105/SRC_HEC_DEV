...
<body id="mainMenu">
	<div>
		<ul class="help_menu">
	        <li class="helptitle2" id="title1">
	            <span style="font-size:14px;"><img src="${root}${HTML_IMG_DIR}/icon_csr.png">&nbsp;Change Management</font>	
	...
	<div id="foldframe" class="foldframe">
		<div>
        	<ul class="help_menu">
                 <!-- 프로젝트 그룹 -->
                 <li class="helpstitle"><a id="menuCng1" onclick="setSubFrame(1);"><img src="${root}${HTML_IMG_DIR}/csr_minus.png">&nbsp;${menu.LN00277}</a></li>
                 
                 <!-- 프로젝트 -->
                 <li class="helpstitle"><a id="menuCng2" onclick="setSubFrame(2);"><img src="${root}${HTML_IMG_DIR}/csr_minus.png">&nbsp;${menu.LN00131}</a></li>
                 
            	 <!-- CSR List -->
                 <li class="helpstitle"><a id="menuCng3" onclick="setSubFrame(3);"><img src="${root}${HTML_IMG_DIR}/csr_minus.png">&nbsp;Change Service Request</a></li>
                 
                 <!-- Change set -->
                 <li class="helpstitle"><a id="menuCng4" onclick="setSubFrame(4);"><img src="${root}${HTML_IMG_DIR}/csr_minus.png">&nbsp;Change set</a></li> 
				...
				<!-- Issue 등록 -->
	            <!-- li class="helpstitle line"><a id="menuCng7" onclick="setSubFrame(7);"><img src="${root}${HTML_IMG_DIR}/csr_minus.png" >&nbsp;Issue</a></li-->              	 	         
             </ul>
    	</div>
	</div>
