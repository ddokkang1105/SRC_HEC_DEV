...
function setGridData(){
	...
	result.header = "${menu.LN00024},Version,${menu.LN00129},${menu.LN00131},#cspan,${menu.LN00022},${menu.LN00004},${menu.LN00063},${menu.LN00070},${menu.LN00095},${menu.LN00027},${menu.LN00094},ChangeSetID,ProjectID,RequestUserId,ChangeStsCode,Task,ParentID";
	result.cols = "Version|CSRID|ProjectName|ImgPjtInfoView|ChangeType|RequestUserName|RequestDate|CompletionDate|ApproveDate|ChangeSts|ApprovedUserName|ChangeSetID|ProjectID|RequestUserId|ChangeStsCode|ImgTaskInfoView|ParentID";
