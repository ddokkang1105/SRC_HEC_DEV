...
<script type="text/javascript">
	...
	function setGridData(){
		...
		result.header = "${menu.LN00024},#master_checkbox,${menu.LN00021},SOP No.,${menu.LN00247}, ${menu.LN00353}, ${menu.LN00354}, SOP명, ${menu.LN00018}, ${menu.LN01007}, ${menu.LN00356}, ${menu.LN00357}, File, ItemID, ClassCode, SeqLevel, authorID,myItemCnt";
		result.cols = "CHK|ItemTypeName|Identifier|TeamName|L1Name|L2Name|ItemName|OwnerTeamName|Name|CSVersion|ValidFrom|FileIcon|ItemID|ClassCode|SeqLevel|AuthorID|myItemCnt";
		result.widths = "30,30,60,120,150,120,150,*,120,80,80,60,60,0,0,0,0,0"; // item 검색
		result.sorting = "int,int,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str";
		result.aligns = "center,center,center,center,center,center,center,left,center,center,center,center,center,center,center,center,center,center";
	...
	function editCheckedAllItems(avg){ 
		...
		for(var i = 0 ; i < checkedRows.length; i++ ){			
			...
			if (items == "") {
				...
				myCnt = p_gridArea.cells(checkedRows[i],17).getValue();
