...
// 		ajaxSubmitNoAdd(document.langFrm, "templateSetting.do?templCode="+tmplCode, "blankFrame");
    ...
    function fnSearchMain(){
		var searchMode = $(".search_form select").val();
	...
	<header>
		<!-- logo -->
		  ...
		  <div class="search_form">
			...
			<input id="searchValue" name="searchValue" placeholder="Search" type="text">	<button class="btn-search" type="button" onClick="fnSearchMain()"><img src="${root}${HTML_IMG_DIR}/btn_icon_search.png" alt="검색"></button>
			</div>
			<ul class="h_right">
					<li class="hypen ">			
					<form name="templFrm" id="templFrm" action="#" method="post" onsubmit="return false;">	
						<ul id="nav" style="width:75px;">
							<li class="top"><span id="cmbTemplate">${templText}</span>							
							<ul class="sub2" style="width:75px;">
