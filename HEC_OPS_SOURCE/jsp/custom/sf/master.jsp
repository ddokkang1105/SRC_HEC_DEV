...
<script type="text/javascript">
	...
	function setInit(){
		...
		changeTempl('${templCode}','${templText}','${mainURL}','${mainScnText}','${mainUrlFilter}','${tmplFilter}','${projectID}','',arcLinkYN);
	...
	function changeTempl(layerType,layerText, mainUrl, mainScnText, mainUrlFilter, tmplFilter, tmplProjectID, tmplType, arcLinkYN) { 
		if(layerType==null||layerType==undefined){
			layerType="${templCode}";
		}else{
			$("#layerTypeHmBtn").val(layerType);
...
// 		ajaxSubmitNoAdd(document.langFrm, "templateSetting.do?templCode="+tmplCode, "blankFrame");
	...
	function getTreeSubItems(subItems){
	 ...
	 function clickMainMenu(menuType, menuName, menuIcon, defDimValueID, menuStyle, scndMenuStyle, menuUrl, boardMgtID, mainType, tmplFilter, projectID, tmplType, refreshYN, s_itemID, scrnMode){ 
		...
		}else if(menuType == "MYPAGE"){url = "mySpaceV34.do?srID=${srID}&myPageTmplFilter=${myPageTmplFilter}&tmplFilter="+tmplFilter; name = "MYPAGE";
...
<div id="maincontainer">
	...
	<div id="topsection">
		...
		<div class="floatR" id="MemInfo">
			<ul class="floatR">
			<li class="pdR10 pdL20"><img src="${root}${HTML_IMG_DIR}/icon_mypage.png"/></li>
...
<%-- 				</c:if>			 --%>
				...
				<li class="help pdL15 hypen pdT1" alt="HELP" title="HELP" style="cursor:pointer">Help</li>
			</ul>
			<ul class="floatR mgR30">
				<li id="searchType">
					<select>
