...
<script type="text/javascript">
	...
	$(document).ready(function() {
		initTree();
		fnSelect("Category","&Category=PJTCAT","dictionyCode","");
		fnSelect("PStatus","&Category=PJTSTS","dictionyCode","");
		fnSelect("Reason","&Category=CR","dictionyCode","");
		fnSelect("Type","&Category=CNGT1","dictionyCode","");
	});	
	//===============================================================================
