...
<script type="text/javascript">
	...
	var id="<%=id%>";var scrnType="<%=scrnType%>";
	var screenMode="<%=screenMode%>";var MTCategory="<%=MTCategory%>";
	...
	jQuery(document).ready(function() {		
		fnSetVisitLog(id);		
		// if(  '${loginInfo.sessionMlvl}' != "SYS"){fnCheckUserAccRight(id, "fnGetMenuPage("+id+")", "${WM00033}");	}else{
			fnGetMenuPage(id);
		//}
	});
