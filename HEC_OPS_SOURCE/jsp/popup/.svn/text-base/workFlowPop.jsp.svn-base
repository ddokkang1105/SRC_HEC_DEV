...
<body>
	...
	<form name="WorkFlowFrm" id="WorkFlowFrm" action="#" method="post" onsubmit="return false;">
		...
		<table id="newObject" class="tbl_blue01" width="100%;">
			...
			<tr>
				...
				<td  class="last viewtop">
					<input type="text" class="text" id="objWFID" name="objWFID" value="${Maxlovcode}"/>
				</td>
			</tr>
		...
		<div class="alignBTN">
			&nbsp;<span class="btn_pack medium icon mgR10"><span class="save"></span><input value="Save" type="submit" onclick="saveWorkFlow()"></span>
		</div>
