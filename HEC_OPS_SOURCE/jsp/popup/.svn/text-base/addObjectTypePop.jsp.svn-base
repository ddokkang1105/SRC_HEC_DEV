...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		fnSelect('objCategory', '', 'ObjCategoryCode', '${Category}');
		 ...
		 <div class="mgT5 mgL5 mgR5">
			...
			<!-- ID -->
				...
				<tr>
					...
					<td  class="viewtop last">
						...
						name="objItemTypeCode" value="${MaxObjectTypeCode}"/>
					</td>
				</tr>
			...
			<!-- 명칭 -->
				...
				<tr>
					<th>Category</th>
					<td  class="last">
						<select id="objCategory" name="objCategory" style="width:100%;" disabled="disabled"></select>
					</td>
				</tr>
