...
<body id="mainMenu">
	<form name="boardMainFrm" id="boardMainFrm"></form>
		...
		<div id="carframe">
			<div>
				<ul class="help_menu">
					 <li class="helptitle2" style="border-bottom:0;"><img src="${root}${HTML_IMG_DIR}/icon_board.png">&nbsp;${templName}</li>
						<!-- 1.Board -->
	                 	<c:forEach var="grpList" items="${boardGrpList}" varStatus="grpStatus">
		                 <li class="helpstitle line plus${grpStatus.count}"> 	                 
		                 <a onclick="clickOpenClose(${grpStatus.count});"><img src="${root}${HTML_IMG_DIR}/icon_pjt_brd.png"><span class="fontchange">&nbsp;${grpList.BoardGrpName}</span></a>
		                 </li>
		                 <li style="display:none;" class="helpstitle line minus${grpStatus.count}">	                 
		                 <a class="on" onclick="clickOpenClose(${grpStatus.count});"><img src="${root}${HTML_IMG_DIR}/icon_pjt_brd.png"><span class="fontchange">&nbsp;${grpList.BoardGrpName }</span></a>
		                 </li>
