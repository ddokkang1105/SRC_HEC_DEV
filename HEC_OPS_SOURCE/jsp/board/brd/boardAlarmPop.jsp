	...
	<div class="szone" >
  		<div class="con01">
  			<table class="tbl_brd" style="table-layout:fixed;width:668px;" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="4" style="height:230px;" class="tit last">
						<div style="width:645px;height:213px;overflow:auto;padding:10px;box-sizing: content-box;">
							${resultMap.Content}
						</div>
					</td>
				</tr>
        ...
        <div class="popup02Close mgL10 mgT10" style="float:left !important">
         ...
         <div class="floatL mgR10  mgT10" style="cursor:pointer;float:right !important">
