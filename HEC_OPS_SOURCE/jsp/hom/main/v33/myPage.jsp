...
<script type="text/javascript">
	...
	function setSubFrame(avg, option){ 
		...
		if(avg == "10") {
			...
			if(option == "srView"){
				var srID = "${srID}"; 				
				data = data + "&srType=${srType}&srMode=mySR&srStatus=ING&screenType=srRcv&srID=${srID}&mainType=mySRDtl${srVarFilter}";	
			}else {
				data = data + "&srType=${srType}&srMode=mySR&srStatus=ING&screenType=srRcv&pageNum=1${srVarFilter}"; 		
		    }
		} 
