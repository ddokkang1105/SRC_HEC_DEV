...
var mainType = "${mainType}";
	...
	$(document).ready(function(){
		...
		setSubFrame(10, "srView"); //SR Processing detail
		 ...
		 else if(mainType == "myModeItem") {clickOpenClose(2); setSubFrame(2);}
...
<body id="mainMenu">
    ...
    <div>
       	<ul class="help_menu">
           	...
           	<li class="helpstitle line minus1" style="display:none;"><a class="on" onclick="clickOpenClose(1);"><img src="${root}${HTML_IMG_DIR}/icon_pjt_chorder.png"><span class="fontchange">&nbsp;To Do list</span></a></li>
      	    ...
      	    <li class="hlepsub line smenu1" style="display:none;"><a id="menuCng1" onclick="setSubFrame(1);">&nbsp;Q&A</a></li>
      	      	 
			<!-- 2.Contents -->
			<c:if test="${apprSystem != 'OLM'}" >
               	<li class="helpstitle line plus2"><a onclick="clickOpenClose(2);"><img src="${root}${HTML_IMG_DIR}/icon_brd_01.png"><span class="fontchange">&nbsp;Contents</span></a></li>
            </c:if>
            <c:if test="${apprSystem == 'OLM'}" >
                ...
                <li class="helpstitle line minus2" style="display:none;"><a class="on" onclick="clickOpenClose(2);"><img src="${root}${HTML_IMG_DIR}/icon_pjt_chorder.png"><span class="fontchange">&nbsp;Contents</span></a></li> 
			...
			<c:if test="${sessionScope.loginInfo.sessionLogintype ne 'viewer'}">
	                 ...
	                 <li class="helpstitle line minus4" style="display:none;"><a class="on" onclick="clickOpenClose(4);"><img src="${root}${HTML_IMG_DIR}/icon_brd_02.png"><span class="fontchange">&nbsp;${menu.LN00287}</span></a></li>
	             		<c:forEach var="list" items="${reportList}" varStatus="status">
							<li class="hlepsub line smenu4"><a id="menuCng${startReportIndex + status.count}" onclick="setRptFrame('${startReportIndex + status.count}','${list.ReportURL}?${list.VarFilter}&reportCode=${list.ReportCode}');">&nbsp;${list.ReportName}</a>
							</li>
						</c:forEach>   
				</c:if>    
