...
<script type="text/javascript" src="${root}cmm/js/dhtmlx/dhtmlxSidebar/codebase/suite.js?v=6.4.3"></script>
<link rel="stylesheet" href="${root}cmm/js/dhtmlx/dhtmlxSidebar/codebase/suite.css?v=6.4.3">
...
var viewData = [
                { 
                     id: "toggle",
     				css: "toggle-button",
     				html: "<div class='title'><img src='${root}${HTML_IMG_DIR}/icon_fold.png'/><span class='title'>My Page</span></div>",
                 },            
                 { 
                     id: "user",
     				html: "<div>" 
                 ...
                 },
                 {
                     ...
                     items: [
	                         ...
	                         
	                         {
	                             ...
	                             value: "ReqUserAuth",
	                             icon: "mdi mdi-settings",
	                             html: "<div><img src='cmm/js/dhtmlx/dhtmlxSidebar/codebase/images/icon_sidebar_setting.png'/><span class='mgL15'>Request Authorization</span></div>",
	                         }
	...
	function setPage(id){
		...
		if(id === "toggle"){
			...
			if(sidebar.config.collapsed){
				...
				sidebar.data.update("toggle", {html: "<div><img src='${root}${HTML_IMG_DIR}/icon_fold.png'/><span class='title'>My Page</span></div>"});
			...
			return;
       		...
       		parent.goMenu('mySpaceV34.do?srType=${srType}', '', true, layout_2E);
			return;
		}else if(id == "srNew"){
			url = "esrListMgt.do";
			data =  "srMode=mySR&searchStatus=NEW&pageNum=1&srType=${srType}&scrnType=srRqst";
		}else if(id == "srIng"){
			url =  "esrListMgt.do";
			data = "srMode=mySR&srStatus=ING&pageNum=1&srType=${srType}&scrnType=srRqst&mainType=mySRDtl";		
		}else if(id == "srTeamIng"){
			url =  "esrListMgt.do";
			data = "srMode=myTeam&srStatus=ING&pageNum=1&srType=${srType}&scrnType=srRqst&mainType=mySRDtl";		
		}else if(id == "srReq") {
			url =  "esrListMgt.do";
			data =  "srMode=mySR&pageNum=1&srType=${srType}&scrnType=srRqst";			
		}else if(id == "srAll"){
			url =  "esrListMgt.do";
			data =  "srMode=mySR&pageNum=1&srType=${srType}&scrnType=srRqst&srStatus=ALL";
		}else if(id == "srDesk"){
			url = "srAreaInfo.do";
			data = "srType=${srType}";
		}else if(id == "ownerPjt"){
						...
						<div class="cntFrame">
							<div class="sec" style="background:#4265EE">
								...
								<ul class="con">
									...
									<li class="" onClick="goMyPage('myModeItem')"><p>${itemModeCnt}</p>${menu.LN00344}</li>
								</ul>
							</div>
